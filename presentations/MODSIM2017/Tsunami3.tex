...
\begin{document} 
	...
	\addplot [ blue] coordinates {(0,0.8) (0.48,0.8)};
	\addplot [smooth, blue] coordinates {(0.48,0.8) (0.51,0.9) (0.5125,0.8) };
	\addplot [ blue] coordinates {(0.5125,0.8) (0.66,0.8)};
	...
	\node[above] at (0.5,0.9) {\color{red}{3}};
