...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {conhN.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {conuhN.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {conGN.dat};
\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {conHN.dat};
