...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {conhFN.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {conuhFN.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {conGFN.dat};
%\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {conHF.dat};
\logLogSlopeTriangle{0.9}{0.2}{0.4}{5}{black};
