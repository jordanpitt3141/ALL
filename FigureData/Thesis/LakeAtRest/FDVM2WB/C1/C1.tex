...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {hC1.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {uhC1.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {GC1.dat};
\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {HC1.dat};
