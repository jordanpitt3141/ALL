...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {hLI.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {uLI.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {GLI.dat};
