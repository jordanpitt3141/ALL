...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {hL1dn.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {uL1dn.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {GL1dn.dat};

\logLogSlopeTriangleLeft{0.8}{0.35}{0.05}{1}{black};
