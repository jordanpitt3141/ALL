...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {./Data/o3/conh.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {./Data/o3/conuh.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {./Data/o3/conG.dat};
\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {./Data/o3/conH.dat};
\logLogSlopeTriangleUpsideDown{0.6}{0.25}{0.7}{3}{black};
