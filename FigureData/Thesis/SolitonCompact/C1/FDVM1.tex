...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {./Data/o1/conh.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {./Data/o1/conuh.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {./Data/o1/conG.dat};
\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {./Data/o1/conH.dat};

\logLogSlopeTriangleUpsideDown{0.5}{0.4}{0.9}{1}{black};
