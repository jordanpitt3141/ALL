...
\addplot [blue,only marks,mark =triangle,mark size =0.9mm] table {h.dat};
\addplot [black,only marks,mark =square,mark size =0.75mm] table {uh.dat};
\addplot [red,only marks,mark =o,mark size =0.75mm] table {G.dat};
\addplot [green!60!black,only marks,mark =x,mark size =0.8mm] table {H.dat};
