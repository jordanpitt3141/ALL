...
%DIF DEL ../DBEnew/DamBreak.tex     Tue Aug 29 13:22:11 2017
%DIF ADD ../DBEnewv2/DamBreak.tex   Mon Oct 23 12:46:17 2017
...
The \DIFaddbegin \DIFadd{short term }\DIFaddend mean behaviour of numerical solutions to the dam-break problem for the Serre equations is consistent across the literature \cite{El-etal-2006,Zoppou-etal-2016,Zoppou-etal-2017,Hank-etal-2010-2034,Mitsotakis-etal-2014,Mitsotakis-etal-2017}\DIFdelbegin \DIFdel{and was demonstrated to be well approximated by the analytical solution }\DIFdelend \DIFaddbegin \DIFadd{. In the long term the mean behaviour of the solution of the Serre equations }\DIFaddend to the dam-break problem \DIFdelbegin \DIFdel{by the }\DIFdelend \DIFaddbegin \DIFadd{is given by the analytical solution of the }\DIFaddend shallow water wave equations \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034,Mitsotakis-etal-2014}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{to the dam-break problem \mbox{%DIFAUXCMD
...
The second aim of this paper is to \DIFdelbegin \DIFdel{assess the utility }\DIFdelend \DIFaddbegin \DIFadd{compare our numerical solutions with the analytical solution }\DIFaddend of the shallow water wave equations \DIFdelbegin \DIFdel{as a guide for the evolution of an undular bore and compare our numerical solutions with }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend the Whitham modulation results of \citet{El-etal-2006}. We \DIFdelbegin \DIFdel{find }\DIFdelend \DIFaddbegin \DIFadd{confirm }\DIFaddend that for a range of dam-break problems the analytical solution of the shallow water wave equations \DIFdelbegin \DIFdel{is a good approximation for }\DIFdelend \DIFaddbegin \DIFadd{captures }\DIFaddend the mean depth and velocity of the numerical solution of the Serre equations, as \DIFdelbegin \DIFdel{is }\DIFdelend in the literature \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034,Mitsotakis-etal-2014}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034,Mitsotakis-etal-2014,El-Hoefer-2016-11}}%DIFAUXCMD
}\DIFaddend . It was also found that the results of \citet{El-etal-2006} are a good approximation to our numerical solutions. However, unlike the results of \citet{El-etal-2006} and \citet{Mitsotakis-etal-2014} we demonstrate that the Whitham modulation results can underestimate the leading wave height and speed in the near term, even when the ratio of the two water depths is below the critical value.
...
Because there are no known analytic solutions to the dam-break problem for the Serre equations the literature has relied on comparisons to simpler equations such as the shallow water wave equations \cite{Hank-etal-2010-2034,Mitsotakis-etal-2014} or asymptotic solutions \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{El-etal-2006} }%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{El-etal-2006,El-Hoefer-2016-11} }%DIFAUXCMD
}\DIFaddend to understand the behaviour of the Serre equations for the dam-break problem.

\DIFdelbegin \DIFdel{It was demonstrated by \mbox{%DIFAUXCMD
\citet{Hank-etal-2010-2034} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citet{Mitsotakis-etal-2014} }%DIFAUXCMD
that }\DIFdelend \DIFaddbegin \DIFadd{For instance }\DIFaddend the analytical solution of the shallow water wave equations for the dam-break problem captures the mean behaviour of the \DIFdelbegin \DIFdel{numerical }\DIFdelend solutions of the Serre equations to the dam-break problem \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034} }%DIFAUXCMD
and the }\DIFdelend \DIFaddbegin \DIFadd{in the long term \mbox{%DIFAUXCMD
\cite{El-Hoefer-2016-11}}%DIFAUXCMD
. This was also demonstrated for the short term numerical solutions of the Serre equations for a dam-break problem \mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034} }%DIFAUXCMD
and a }\DIFaddend smoothed dam-break problem \cite{Mitsotakis-etal-2014}. 
...
The \DIFdelbegin \DIFdel{analytical solutions }\DIFdelend \DIFaddbegin \DIFadd{dispersive shock fitting method outlined in the review article of \mbox{%DIFAUXCMD
\citet{El-Hoefer-2016-11}}%DIFAUXCMD
, demonstrates that asymptotically the means of $h$ and $u$ inside the undular bore of the Serre equations are equal to the height and velocity inside the bore }\DIFaddend of the shallow water wave equations\DIFdelbegin \DIFdel{have been used as a guide for the mean behaviour of }\DIFdelend \DIFaddbegin \DIFadd{. This is the basis for the comparison in the literature \mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034,Mitsotakis-etal-2014} }%DIFAUXCMD
between }\DIFaddend the numerical solution of the Serre equations \DIFaddbegin \DIFadd{and the analytic solutions of the shallow water wave equations }\DIFaddend for the dam-break problem\DIFdelbegin \DIFdel{in the literature \mbox{%DIFAUXCMD
\cite{Hank-etal-2010-2034,Mitsotakis-etal-2014}}%DIFAUXCMD
}\DIFdelend .

\DIFdelbegin \DIFdel{To assess the applicability of this }\DIFdelend \DIFaddbegin \DIFadd{This relationship was investigated in the short term with our numerical solutions by using }\DIFaddend the mean bore depth and mean fluid velocity in the interval [$x_{u_2}-50m$,$x_{u_2}+50m$] \DIFdelbegin \DIFdel{were calculated }\DIFdelend from our numerical \DIFdelbegin \DIFdel{solution }\DIFdelend \DIFaddbegin \DIFadd{solutions }\DIFaddend to the smoothed dam-break problem with various height ratios. These means were compared to \DIFdelbegin \DIFdel{their approximations from }\DIFdelend the analytical solution of the dam-break problem for the shallow water wave equations\DIFaddbegin \DIFadd{, which gives the height }\DIFaddend $h_2$ and \DIFaddbegin \DIFadd{velocity }\DIFaddend $u_2$ \DIFaddbegin \DIFadd{inside the bore}\DIFaddend . The results of this can be seen in Figure \ref{fig:ratiotest} for numerical solutions of $\mathcal{V}_3$ with $\Delta x = 10/2^{9}m$ to the smoothed dam-break problem at $t=100s$ with $\alpha = 0.1m$ where $h_0$ is fixed and $h_1$ is varied.

We use a final time of $t=100s$ as it allows the internal structure of the bore to develop more fully giving a more reliable mean estimate, as a consequence we resort to a coarser grid to keep the run-times reasonable. We find that decreasing $\Delta x$ does not significantly alter the mean of $h$ and $u$. We also find that \DIFdelbegin \DIFdel{increasing }\DIFdelend \DIFaddbegin \DIFadd{decreasing }\DIFaddend $\alpha$ also does not significantly alter the mean of $h$ and $u$. Therefore, the mean behaviour of the true solution of the Serre equations to the dam-break problem is captured by these numerical solutions, if it exists.

It can be seen that $h_2$ and $u_2$ are \DIFdelbegin \DIFdel{good approximations }\DIFdelend \DIFaddbegin \DIFadd{very close }\DIFaddend to the mean behaviour of the fluid inside the bore for a range of different aspect ratios. Although, as $h_1/h_0$ increases this approximation becomes worse, so that $h_2$ becomes an underestimate and consequently $u_2$ is an overestimate. Most likely this is due to the increasing influence of non-linearity on the undulations. 

We find that for $h_1/h_0 = 1.8$ the mean values of $h$ and $u$ inside the bore for the Serre equations are not equal to $h_2$ and $u_2$. This can be seen in Figure \ref{fig:uhSWWcomp} for the numerical solutions of $\mathcal{V}_3$ with $\Delta x = 10/2^{9}m$ to the smoothed dam-break problem with $\alpha = 0.1m$ at $t=300s$. It can be seen that $h_2$ is an underestimate of $h$ and $u_2$ is an overestimate of $u$ although the difference between these values and the mean behaviour of the Serre equations is small and only noticeable over long time periods. \DIFaddbegin \DIFadd{This agreement is quite good given that, we are numerically solving the smoothed dam-break problem and the equality of these values is an asymptotic result.
}\DIFaddend 
...
We observe that as our numerical solutions evolve over time, oscillations appear to be released from the contact discontinuity and travel away from it in both directions, leading to \DIFaddbegin \DIFadd{a }\DIFaddend decay of amplitudes around the contact discontinuity. Therefore, the contact discontinuity is an important feature and its behaviour determines the structure of the oscillations in regions III and IV. 
