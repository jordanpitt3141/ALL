...
Examination of the $L_2$ errors depicted in Figure \ref{fig:LARL2C}(a) reveals that the method reproduced $h$, $G$ and $u$ precisely, accounting for round-off errors. The errors for $h$, $G$ and $u$ are increasing as $\Delta x \rightarrow 0$ due to an accumulation of round-off errors. 
