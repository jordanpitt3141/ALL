...
The experimental results of the second-order finite difference volume method for the periodic waves over a submerged bar experiments of \citet{Beji-Battjes-1994-1} are reproduced in Chapter \ref{chp:ExpMethodComp}.} 
