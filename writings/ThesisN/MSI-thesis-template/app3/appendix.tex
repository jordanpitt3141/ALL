...
\end{align*}
%\end{subequations*}
To calculate the total $h$ and $\mathcal{H}$ in the solution we must partition the domain into wet regions where $b(x) < a_0$ and dry regions where $b(x) \ge a_0$. For the dry regions $h$ and $\mathcal{H}$ are zero everywhere and so we have 
%\begin{subequations}
