...
\end{equation}
 ...
 We derive $\matr{E}$ in \eqref{eqn:linearanalaim} for $\text{FEVM}_2$ and perform the convergence and dispersion analysis. We then present the results of the analyses for $\text{FDVM}_1$, $\text{FDVM}_2$, $\text{FDVM}_3$, $\mathcal{D}$ and $\mathcal{W}$.
...
\begin{table}
	\begin{tabular}{l c}
		...
		\hline
	\end{tabular}
	\caption{Lowest order $\Delta t$ term of the Taylor series for the elements of $\matr{E} - e^{i \omega^+ \Delta t} \matr{I}$ for all values of $Fr$. Here $\beta = 3 + k^2 H^2$.}
...
\begin{table}
	...
	\hline
		...
		\hline 
	\end{tabular}
	\caption{Lowest order terms of the Taylor series for the elements of $\matr{E} - e^{i \omega^+ \Delta t} \matr{I}$ for all values of $Fr$. Here $\beta = 3 + k^2 H^2$.}
	\label{tab:EerrFDVM2} 
\end{table}
\begin{table}
	\begin{tabular}{l c c}
...
\begin{table}
	...
	\end{tabular}
	\caption{Lowest order terms of the Taylor series for the elements of $\matr{E} - e^{i \omega^\pm \Delta t} \matr{I}$ for all values of $Fr$. Here $\beta = 3 + k^2 H^2$.}
	\label{tab:EerrD} 
\end{table}
\begin{table}
	\begin{tabular}{l  c c}
...
\begin{table}
	...
	\end{tabular}
	\caption{Lowest order terms for $\widetilde{\omega}^+-\omega^+$ for all FDVM and the FEVM. With $  -1 \le Fr \le 1$ and $\beta = 3 + H^2 k^2 $. }
	\label{tab:Wfactor} 
\end{table}
...
\begin{table}
	...
	\hline
		...
		\hline
	\end{tabular}
	\caption{Lowest order $\Delta x$ term for $\widetilde{\omega}^+-\omega^+$ for all FDVM and the FEVM for supercritical Froude numbers where different from Table \ref{tab:Wfactor}. With $\beta = 3 + H^2 k^2 $. }
...
\end{tabular}
	\caption{Lowest order terms of $\widetilde{\omega}^+-\omega^+$ for $\mathcal{D}$ and $\mathcal{W}$. }
