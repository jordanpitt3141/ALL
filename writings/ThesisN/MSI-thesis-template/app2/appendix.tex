...
Since the evolution matrix can be represented in two ways, it will now be stated whether $\matr{E}$ or $\matr{E}^{\left(2 \times 2\right)}$ were used in the convergence and dispersion analysis of the FDM. 
