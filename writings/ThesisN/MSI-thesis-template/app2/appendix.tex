...
\end{bmatrix}^{n}_j.
\end{equation*}
The evolution matrix $\matr{E}$ is obtained by applying the numerical method to \eqref{appC:ConLawFormLin} and making use of \eqref{eqn:fourfac} for all quantities.
