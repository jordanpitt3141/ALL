...
\label{section:}
The conservation of mass equation \eqref{eq:Serre_continuity} has no mixed derivative term standard numerical techniques for conservation laws can be used. In particular the Lax-Wendroff method as done by \citeN{El-etal-2006}, here we present the method in replicable detail.
...
\subfigure[][]{\label{fig:FDo2Enorm}\includegraphics[width=7cm]{pics/results/soliton/C1/FDc.pdf}}
\subfigure[][]{\label{fig:grimo2normL1}\includegraphics[width=7cm]{pics/results/soliton/L1/grim.pdf}}
\subfigure[][]{\label{fig:grimo2Enorm}\includegraphics[width=7cm]{pics/results/soliton/C1/grim.pdf}}
...
\subfigure[][]{\label{fig:o3a1dxlimC1}\includegraphics[width=7cm]{pics/results/SDB/Con/1.pdf}}
...
\caption{Numerical solution of the smoothed dam break with $\mathcal{V}_3$, $\beta = 0.294$ and $\Delta x = 10/2^{9}$ at $t=$ $30s$ (a), $100s$ (b), $200s$ (c) , $300s$ (d).}
...
\begin{figure}
	...
	\caption{Proportion of $\mathcal{H}$ made up by horizontal kinetic energy ({\color{blue} \solidrule}) , vertical kinetic energy ({\color{red} \solidrule}) and gravitational potential energy ({\color{green!80!black} \solidrule}) for $\mathcal{V}_3$ solution of the smooth dam break with $\beta = 0.2944$ and $\Delta x = 10/2^{9}$ over time.}
	\label{fig:PHTa12all}
\end{figure}
%--------------------------------------------------------------------------------
\section{Conclusions}
