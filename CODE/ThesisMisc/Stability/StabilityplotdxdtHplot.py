...
us = [0,0.01,0.1,1,10,100]
Hs = [0.001,0.1,1,10,100]
ks = [0.001,0.1,1,10,100]

dxs = linspace(tol2,1,num=70) 
dts = linspace(tol2,1,num=70) 
g = 9.81

for k in ks:
    
    sdir = "../../../../../data/ThesisRAW/StabilityFixed/Cr0p5Picsdxdt/"   + "k"+str(k) +"/"
    ...
    for h in Hs:
        for u in us:
            ...
            legend(loc=2)
            s = sdir + "o2FEMU" + str(u)  + "h" + str(h)  + ".png"
            savefig(s, bbox_inches='tight')
            clf()    
