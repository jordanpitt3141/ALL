...
wdir = "../../../../data/ThesisRAW/Stabilitykvsrho/U"+ str(u)+ "/H" + str(h) + "/dx"+ str(dx) + "/"
...
ks = linspace(10**(-6),2*pi / dx,num=2000)  
n1 = len(ks)
...
xlabel("k")
ylabel("Growth Factor")
#plot(ks,array(Ps) - 1,label="o1")
plot(ks,array(Rs) -1,label="o2")
plot(ks,array(Ss) - 1,label="o2FEM")
#plot(ks,array(Ns) - 1,label="o3")
plot(ks,array(Ms) - 1,label="Naive FD")
plot(ks,array(Qs) - 1,label="Lax Wendroff")
