...
Hs = [0.1,1,10,100]
us = linspace(100,1000,num=50)  
g = 9.81
for dx in dxs :
    
    sdir = "../../../../../data/ThesisRAW/StabilityFixed/Cr0p5PicskHUA/"   + "dx"+str(dx) +"/"
