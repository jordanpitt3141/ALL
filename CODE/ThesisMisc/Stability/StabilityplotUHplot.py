...
for dx in dxs :
     for k in ks:
        ...
        sdir = "../../../../../data/ThesisRAW/StabilityCr0p5PicsUHStabSerreFR/"   + "dx"+str(dx) +"/"
        ...
        plot(us, FRH,'-k',label="Fr = 1")
        plot(us, abs(3*g + sqrt(3*(3*g**2 - k**2*us**4))) / (2*k**2*us**2),'--k',label="pSerreFR = 1")
        plot(us, abs(3*g - sqrt(3*(3*g**2 - k**2*us**4))) / (2*k**2*us**2),'-g',label="mSerreFR = 1")
        legend(loc=2)
        ylim([hbeg,hend])
        xlim([ubeg,uend])
        ...
        xlabel("U")
        ylabel("H")        
        plot(bks,bhs,'.',label="stable")
        plot(bksn,bhsn,'.r',label="unstable")
        plot(us, FRH,'-k',label="Fr = 1")
        plot(us, abs(3*g + sqrt(3*(3*g**2 - k**2*us**4))) / (2*k**2*us**2),'--k',label="pSerreFR = 1")
        plot(us, abs(3*g - sqrt(3*(3*g**2 - k**2*us**4))) / (2*k**2*us**2),'-g',label="mSerreFR = 1")
        legend(loc=2)
