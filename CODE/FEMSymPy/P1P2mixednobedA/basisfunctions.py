...
phijm3o2 = quadcontE(x,xjm5o2,xjm2,xjm3o2,xjm1,xjm1o2)
phijm1 = quadcontM(x,xjm3o2,xjm1,xjm1o2)
...
phijp3o2 = quadcontE(x,xjp1o2,xjp1,xjp3o2,xjp2,xjp5o2)

#derivatives
dphijm3o2 = phiEderiv(x,phijm3o2)
dphijm1 = phiMderiv(x,phijm1)
dphijm1o2 = phiEderiv(x,phijm1o2)

dphij = phiMderiv(x,phij )

dphijp1o2 = phiEderiv(x,phijp1o2)
dphijp1 = phiMderiv(x,phijp1)
dphijp3o2 = phiEderiv(x,phijp3o2)


wjm3o2p = lineardiscP(x,xjm3o2,xjm1o2) 
wjm1o2m = lineardiscM(x,xjm3o2,xjm1o2) 
...
phiEs = [phijm3o2,phijm1o2,phijp1o2,phijp3o2]
phiMs = [phijm1,phij,phijp1]
...
dphiEs = [dphijm3o2,dphijm1o2,dphijp1o2,dphijp3o2]
dphiMs = [dphijm1,dphij,dphijp1]

ws = [wjm3o2p,wjm1o2m,wjm1o2p,wjp1o2m,wjp1o2p,wjp3o2m]
wsNAME = ["wjm3o2p","wjm1o2m","wjm1o2p","wjp1o2m","wjp1o2p","wjp3o2m"]
phiEsNAME = ["phijm3o2","phijm1o2","phijp1o2","phijp3o2"]
phiMsNAME = ["phijm1","phij","phijp1"]
lphiEsNAME = ["phijm1o2","phijp1o2"]
lphiMsNAME = ["phij"]
dphiEsNAME = ["dphijm3o2","dphijm1o2","dphijp1o2","dphijp3o2"]
dphiMsNAME = ["dphijm1","dphij","dphijp1"]
ldphiEsNAME = ["dphijm1o2","dphijp1o2"]
ldphiMsNAME = ["dphij"]
## Cells

cjm1 = [S(xjm3o2),S(xjm1o2)]
cj = [S(xjm1o2),S(xjp1o2)]
cjp1 = [S(xjp1o2),S(xjp3o2)]
