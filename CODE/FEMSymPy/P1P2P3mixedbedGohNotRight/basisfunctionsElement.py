...
with open(s,'a') as file2:
     ...
     ExpressionConvert('wwdd',hyperlist,x,None,None,-1,1,writefile2)  
...
with open(s,'a') as file2:
     ...
     ExpressionConvert('wcdp',hyperlist,x,None,None,-1,1,writefile2)  
...
with open(s,'a') as file2:
     ...
     ExpressionConvert('wcpd',hyperlist,x,None,None,-1,1,writefile2)  
...
with open(s,'a') as file2:
     ...
     ExpressionConvert('ccpp',hyperlist,x,None,None,-1,1,writefile2) 
