...
with open(s,'a') as file2:
     ...
     ExpressionConvertOp('d/w',hyperlist,x,None,None,-1,1,writefile2)  
"""
...
with open(s,'a') as file2:
     ...
     writefile2.writerow(['Integrand','lower bound of integral','upper bound of integral', 'Value of Integral', 'W Term 1', 'W Term 2' , 'W Term 3' , 'D Term 1', 'D Term 2'])        
     ExpressionConvert('wdd',hyperlist,x,None,None,-1,1,writefile2)  
...
with open(s,'a') as file2:
     ...
     ExpressionConvert('wwcdp',hyperlist,x,None,None,-1,1,writefile2)  
...
with open(s,'a') as file2:
     ...
     ExpressionConvert('wwcpd',hyperlist,x,None,None,-1,1,writefile2)  
