...
wdirb = "/home/jp/Documents/PhD/project/data/ThesisRaw/SolitonFD&FEVM/" +FDmeth+"/"
L1hs = []
L1us = []
L1Gs = []
L1Gas = []
...
sdir = "/home/jp/Documents/PhD/project/master/FigureData/Thesis/Soliton/" +FDmeth+"/L2/"
...
for ki in range(6,20):
    ...
    L1h  = norm(hA - h,ord=2)/ norm(hA,ord=2)
    L1u  = norm(uA - u,ord=2)/ norm(uA,ord=2)
    L1G  = norm(GA - G,ord=2)/ norm(GA,ord=2)
    L1Ga  = norm(GA - G1,ord=2)/ norm(GA,ord=2)
