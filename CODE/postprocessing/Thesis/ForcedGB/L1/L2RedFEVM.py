...
sdir = "/home/jp/Documents/PhD/project/master/FigureData/Thesis/Forced/Dry/" +meth1+"/L2RedA/"
...
for ki in range(8,18):
    ...
    L1u = norm(ruC -ruA, ord=2)/ norm(ruA, ord=2)
    L1h = norm(rhC -rhA, ord=2)/ norm(rhA, ord=2)
    L1G = norm(rGC -rGA, ord=2)/ norm(rGA, ord=2)
