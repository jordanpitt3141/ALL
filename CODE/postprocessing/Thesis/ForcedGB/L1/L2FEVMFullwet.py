...
wdirb = "/home/jp/Documents/PhD/project/data/ThesisRaw/Forced/Wet/"+meth1+"/"
L1hs = []
L1us = []
L1Gs = []
dxs=  []

sdir = "/home/jp/Documents/PhD/project/master/FigureData/Thesis/Forced/Wet/" +meth1+"/L2/"
...
for ki in range(8,18):
    ...
    L1u = norm(u -uA, ord=2)/ norm(uA, ord=2)
    L1h = norm(h -hA, ord=2)/ norm(hA, ord=2)
    L1uh = norm(uhC -uhA, ord=2)/ norm(uhA, ord=2)
    L1G = norm(G -GA, ord=2)/ norm(GA, ord=2)
