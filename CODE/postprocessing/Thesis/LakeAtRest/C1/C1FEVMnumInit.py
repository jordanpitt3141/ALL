...
sdir = "/home/jp/Documents/PhD/project/master/FigureData/Thesis/LakeAtRestCalcNumInit/" +meth+"/C1/"
...
for ki in range(8,18):
    ...
    En = GNall(xbc_c,hbc_c,ubc_c,bbc_c,g,n + 2*niBC,niBC,dx) #HankEnergyall(xbc_c,hbc_c,ubc_c,g,n + 2*niBC,niBC,dx)
    ...
    hC1v =abs(MnI -MA)/abs(MA)
    EC1v = abs(EnI - HA)/abs(HA)
    GC1v = abs(GcnI)
    uhC1v = abs(PnI)
