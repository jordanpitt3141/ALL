...
def getufromG(h, G, hebeg, heend, Gebeg, Geend, uebeg, ueend, theta, dx, n, nu, nhbc, nBC, u, hhbc, Ghbc):
    return _Serre2dc.getufromG(h, G, hebeg, heend, Gebeg, Geend, uebeg, ueend, theta, dx, n, nu, nhbc, nBC, u, hhbc, Ghbc)
...
def evolvewrap(G, h, hebeg, heend, Gebeg, Geend, uebeg, ueend, g, dx, dt, n, nBCs, theta, ubc, hhbc, Ghbc):
    return _Serre2dc.evolvewrap(G, h, hebeg, heend, Gebeg, Geend, uebeg, ueend, g, dx, dt, n, nBCs, theta, ubc, hhbc, Ghbc)
