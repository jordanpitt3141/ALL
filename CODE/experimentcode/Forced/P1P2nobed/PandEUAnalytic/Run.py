...
"""
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/AnaCompdxdt/"  
...
for j in range(15):        
    ...
    h,u,G = Forced(x,0,a0,a1,a2,a3,a4,g)
...
# Temporal error
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/AnaComp12/"  
...
for j in range(7,8):        
    ...
    hta,ubcct,Gta = Forced(xubc,ct,a0,a1,a2,a3,a4,g)
    hta,ubcctpdt,Gta = Forced(xubc,ct+dt,a0,a1,a2,a3,a4,g)
      
    ubcct_c = copyarraytoC(ubcct)    
    ubcctpdt_c = copyarraytoC(ubcctpdt) 

    print(ct)
    while ct < endt:
        evolvewrapperconsistenttimeForced(G_c, h_c,hMbeg_c , hMend_c,GMbeg_c ,GMend_c,uMbeg_c,uMend_c,hMbeg1_c , hMend1_c,GMbeg1_c ,GMend1_c,uMbeg1_c,uMend1_c,g,dx, dt,n,GhnBC,unBC,nGhhbc,nubc,theta, hhbc_c,Ghbc_c,ubc_c,Gp_c,hp_c, Gpp_c,hpp_c, x_c, ct, ubcct_c, ubcctpdt_c)        
        ct = ct + dt
        ...
        copywritearraytoC(hMbeg,hMbeg_c)
        copywritearraytoC(hMend,hMend_c)
        copywritearraytoC(uMbeg,uMbeg_c)
        copywritearraytoC(uMend,uMend_c)
        copywritearraytoC(GMbeg,GMbeg_c)
        copywritearraytoC(GMend,GMend_c)
        
        copywritearraytoC(ubcctpdt,ubcct_c)        
        ...
        copywritearraytoC(ubcctpdt,ubcctpdt_c)        
    ...
    getufromG(h_c, G_c,hMbeg_c,hMend_c, GMbeg_c, GMend_c,uMbeg_c,uMend_c,theta,dx , n, 2*n+1,3,unBC,nGhhbc,nubc,u_c,hhbc_c,Ghbc_c);
    hhbcC = copyarrayfromC(hhbc_c,nGhhbc)
    GhbcC = copyarrayfromC(Ghbc_c,nGhhbc) 
...
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/Soliton/Basic/"  
