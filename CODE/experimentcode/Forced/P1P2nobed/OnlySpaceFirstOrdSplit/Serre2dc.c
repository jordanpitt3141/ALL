...
{
    return -3*(sin(2*x) + 10.0)*sin(3*x) + 2*cos(2*x)*cos(3*x);
}

double FluxGdiff(double x, double t)
{
    return -36.0*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(3*x)*cos(3*x) 
        - 36.0*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(3*x)*sin(3*x)*cos(2*x) 
        + 19.62*(sin(2*x) + 10.0)*cos(2*x) - 3*(3*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*cos(3*x) 
        + 6*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(3*x)*cos(2*x) + (sin(2*x) + 10.0)*cos(3*x))*sin(3*x) 
        + (-9*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(3*x) - 12*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(2*x)*sin(3*x) 
        + 36*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*cos(2*x)*cos(3*x) + 24*(sin(2*x) + 10.0)*sin(3*x)*cos(2*x)*cos(2*x) 
        - 3*(sin(2*x) + 10.0)*sin(3*x) + 2*cos(2*x)*cos(3*x))*cos(3*x);
}
