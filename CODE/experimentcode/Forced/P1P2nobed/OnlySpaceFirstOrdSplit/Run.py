...
"""
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/notimedep/All1/"  
...
"""
# Temporal error
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/notimedep/AnaComp1/"  
...
with open(s,'w') as file2:
    ...
    writefile2.writerow(['dx','dt','time','hnorm','unorm','Gnorm'])  


largej = 22
#for j in range(10,11):
for j in range(largej,5,-1):        
    ...
    href,uref,Gref = Forced(x,ct,a0,a1,a2,a3,a4,g)
    ...
    with open(s,'a') as file2:
        ...
        writefile2.writerow([str(dx),str(dt),str(ct),str(hnorm),str(unorm),str(Gnorm)]) 
        
        
    s = wdir +str(j) +"vecs.txt"
    with open(s,'w') as file2:
        writefile2 = csv.writer(file2, delimiter = ',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
        for i in range(n):
            writefile2.writerow([str(x[i]),str(hC[i]),str(uC[i]),str(GC[i]),str(h[i]),str(u[i]),str(G[i])]) 
