...
double GtA(double x, double t)
{
    ...
    {
        return (1 - (3*t + x)/(6*t))/(2*t) 
            + (-1/(2*t) + (3*t + x)/(6*t*t))*(3*t + x)/(6*t) 
            + (1 - (3*t + x)/(6*t))*(-1/t + (3*t + x)/(3*t*t))/(36*t*t) 
            - (1 - (3*t + x)/(6*t))*(3*t + x)/(6*t*t) 
            - (1 - (3*t + x)/(6*t))*(1 - (3*t + x)/(6*t))/(18*t*t*t);
    }
    else
    {
        return 0;
...
double Fluxhdiff(double x, double t)
{
    ...
    {
        return (1 - (3*t + x)/(6*t))/(6*t) - (3*t + x)/(36*t*t);
    }
    else
    {
        return 0;
...
double FluxGdiff(double x, double t)
{
    ...
    {
        return -0.8175*(1 - (3*t + x)/(6*t))/t
               - (4.905 - 0.8175*(3*t + x)/t)/(6*t) 
               + (3*t + x)*((1 - (3*t + x)/(6*t))/(6*t) 
               - (3*t + x)/(36*t*t) 
               - (1 - (3*t + x)/(6*t))/(108*t*t*t))/(6*t) 
               + ((1 - (3*t + x)/(6*t))*(3*t + x)/(6*t)
               + (1 - (3*t + x)/(6*t))*(1 - (3*t + x)/(6*t))/(36*t*t))/(6*t) 
               + (1 - (3*t + x)/(6*t))*(1 - (3*t + x)/(6*t))/(324*t*t*t) 
               + (1 - (3*t + x)/(6*t))*(2 - (3*t + x)/(3*t))/(324*t*t*t);
    }
    else
    {
        return 0;
