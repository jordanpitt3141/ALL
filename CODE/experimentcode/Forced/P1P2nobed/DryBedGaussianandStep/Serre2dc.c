...
{
    return -0.333333333333333*(-1.6*t + 0.8*x - 0.8)*(0.8*t - 0.4*x + 0.4)*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        + 1.13333333333333*(-1.6*t + 0.8*x - 0.8)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        - 0.333333333333333*(1.28*t - 0.64*x + 0.64)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0));
}

double Fluxhdiff(double x, double t)
{
    return 1.0*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0));
}

double FluxGdiff(double x, double t)
{
    return 1.0*(-0.333333333333333*(0.8*t - 0.4*x + 0.4)*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        + 1.13333333333333*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)))*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        - 0.666666666666667*(-0.64*t + 0.32*x - 0.32)*exp(-0.4*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        - 0.666666666666667*(0.8*t - 0.4*x + 0.4)*(0.8*t - 0.4*x + 0.4)*(1.6*t - 0.8*x + 0.8)*exp(-0.4*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        + 1.0*(-0.333333333333333*(-0.64*t + 0.32*x - 0.32)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        - 0.333333333333333*(0.8*t - 0.4*x + 0.4)*(0.8*t - 0.4*x + 0.4)*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)) 
        + 1.13333333333333*(0.8*t - 0.4*x + 0.4)*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0)))*exp(-0.2*(-2.0*t + x - 1.0)*(-2.0*t + x - 1.0));
}
