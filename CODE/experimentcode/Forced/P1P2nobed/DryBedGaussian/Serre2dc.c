...
{
    return -0.166666666666667*(-5.33333333333333*t + 2.66666666666667*x - 5.33333333333333)*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(2.66666666666667*t 
        - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.0555555555555556*(-5.33333333333333*t + 2.66666666666667*x - 5.33333333333333)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.5*(-2.66666666666667*t + 1.33333333333333*x - 2.66666666666667)*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
...
{
    return -0.166666666666667*(-0.444444444444444*t + 0.222222222222222*x - 0.444444444444444)*exp(-0.833333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        - 0.166666666666667*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(3.33333333333333*t - 1.66666666666667*x + 3.33333333333333)*
        exp(-0.833333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.5*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(-0.166666666666667*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*
        (2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.0555555555555556*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.5*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)))*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 4.905*(1.33333333333333*t - 0.666666666666667*x + 1.33333333333333)*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.5*(-0.166666666666667*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*
        exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.222222222222222*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
        + 0.5*(1.33333333333333*t - 0.666666666666667*x + 1.33333333333333)*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.111111111111111*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)))*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0));
}
...
void evolve(double *Ghbc, double *hhbc, double *ubc, int nGhhbc, int nubc, int nGhBC, int unBC, double g, double dx, double dt, int n, double theta, double *newG, double *newh, double *x, double t)
{
    ...
    double hbarn1,hbarn, hfiph,hfimh,Gbarn1,Gbarn, Gfiph,Gfimh,hS, GS;
    ...
    for(i = 0;i < n;i++)
    {
        ...
        newG[i] =(Ghbc[3*(i) +nGhBC + 1]) - dt*idx*((foG ) - (fiG )) + dt*GS;
