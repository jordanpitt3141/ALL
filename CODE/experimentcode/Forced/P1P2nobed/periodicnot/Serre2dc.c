...
{
    return t*(sin(2*x) + 10.0)*cos(2*x);
}

double FluxG(double x, double t, double g)
{
    return t*(-2.66666666666667*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(2*x)*sin(2*x)
            + 4.905*(sin(2*x) + 10.0)*(sin(2*x) + 10.0) + (4*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*cos(2*x)/3 
            + 4*(sin(2*x) + 10.0)*(sin(2*x) + 10.0)*sin(2*x)*cos(2*x) + (sin(2*x) + 10.0)*cos(2*x))*cos(2*x));
}
