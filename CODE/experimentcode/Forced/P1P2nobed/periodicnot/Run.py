...
def hbar(x,t):
    return 10.0*x - cos(2*x)/2;
    
def Gbar(x,t):
    return 20.0*sin(2*x)*sin(2*x)*sin(2*x) \
         - 1.33333333333333*sin(2*x)*sin(2*x)*cos(2*x)*cos(2*x) \
         + 200.25*sin(2*x)*sin(2*x) + 671.666666666667*sin(2*x) \
         - 0.666666666666667*cos(2*x)*cos(2*x)*cos(2*x)*cos(2*x);    
...
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/notdep/6/"  
...
for j in range(30):        
    ...
    hM,u,GM = Forced(x,0,a0,a1,a3,g)
    
    h,G = ForcedAVG(x,0,dx)
    
    hMbeg,uMbeg,GMbeg = Forced(xhMbeg,ct,a0,a1,a3,g)
    hMend,uMend,GMend = Forced(xhMend,ct,a0,a1,a3,g)
     
    hMbeg1,uMbeg1,GMbeg1 = Forced(xhMbeg,ct + dt,a0,a1,a3,g)
    hMend1,uMend1,GMend1 = Forced(xhMend,ct + dt,a0,a1,a3,g)
    ...
    hF,uF,GF = Forced(x,ct,a0,a1,a3,g)
...
"""
# Temporal error
wdir = "../../../../../../data/raw/Forced/o2FEMP1P2/Temporal0.1NANA/"  
