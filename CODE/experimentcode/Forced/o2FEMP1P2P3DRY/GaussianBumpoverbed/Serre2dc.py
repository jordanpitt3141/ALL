...
def getufromG(h, G, bhbc, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, wMbeg, wMend, theta, dx, n, m, nGhBC, unBC, bnBC, nGhbc, nubc, nbbc, u, hhbc, Ghbc, whbc):
    return _Serre2dc.getufromG(h, G, bhbc, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, wMbeg, wMend, theta, dx, n, m, nGhBC, unBC, bnBC, nGhbc, nubc, nbbc, u, hhbc, Ghbc, whbc)
getufromG = _Serre2dc.getufromG

def evolvewrapCONST(G, h, bhbc, hMbeg, hMend, wMbeg, wMend, GMbeg, GMend, uMbeg, uMend, hMbeg1, hMend1, wMbeg1, wMend1, GMbeg1, GMend1, uMbeg1, uMend1, g, dx, dt, n, nGhBC, unBC, bnBC, nGhhbc, nubc, nbhbc, theta, hhbc, whbc, Ghbc, ubc, x, t):
    return _Serre2dc.evolvewrapCONST(G, h, bhbc, hMbeg, hMend, wMbeg, wMend, GMbeg, GMend, uMbeg, uMend, hMbeg1, hMend1, wMbeg1, wMend1, GMbeg1, GMend1, uMbeg1, uMend1, g, dx, dt, n, nGhBC, unBC, bnBC, nGhhbc, nubc, nbhbc, theta, hhbc, whbc, Ghbc, ubc, x, t)
