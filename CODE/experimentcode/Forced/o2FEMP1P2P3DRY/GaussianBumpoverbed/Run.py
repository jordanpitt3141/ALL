...
def ForcedbedM(x,t,c,a0,a1,a2,a3,b1,b2,g,dx):
    ...
    cxv = x[0] - dx
    b.append(sin(b2*(cxv - 0.5*dx)))
    b.append(sin(b2*(cxv - dx/6.0)))
    bavg= -(cos(b2*(cxv + 0.5*dx)) - cos(b2*(cxv - 0.5*dx)))/(b2*dx)
    b.append(bavg)
    b.append(sin(b2*(cxv + dx/6.0)))
    b.append(sin(b2*(cxv + 0.5*dx)))
...
wdir = "../../../../../../data/raw/Forced/P1P2P3BedFEM/GaussBed/e1dt2/"  
...
for j in range(12,13):
    ...
    h,u,G,bhbc,w = ForcedbedM(x,t,c,a0,a1,a2,a3,b1,b2,g,dx)
    #bM = cos(a5*x)
    ...
    while t < endt:
        evolvewrapCONST(G_c,h_c,bhbc_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c,GMend_c,uMbeg_c,uMend_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c,GMend_c,uMbeg_c,uMend_c,g,dx,dt,n,GhnBC,unBC,bnBC,nGhhbc,nubc,nbhbc,theta,hhbc_c,whbc_c,Ghbc_c,ubc_c,x_c,t)
    ...
    hA,uA,GA,bhbc,wA = ForcedbedM(x,t,c,a0,a1,a2,a3,b1,b2,g,dx)
