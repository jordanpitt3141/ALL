...
void getufromG(double *h, double *G, double *bhbc, double *hMbeg, double *hMend, double *GMbeg, double *GMend,double *uMbeg, double *uMend,double *wMbeg, double *wMend,double theta, double dx , int n, int m, int nGhBC,int unBC,int bnBC, int nGhbc, int nubc, int nbbc, double *u, double *hhbc,double *Ghbc, double *whbc)
{
    ...
    for (i =1;i < n-1 ; i++)
    {
      // Reconstruct G and h
        ...
        wi = h[i] + bhbc[4*(i) + iboffBC ];
        wip1 = h[i+1] + bhbc[4*(i+1) + iboffBC ];
        wim1 = h[i-1] + bhbc[4*(i-1) + iboffBC ];
        dwib = (wi - wim1);
        dwim = 0.5*(wip1 - wim1);
        dwif = (wip1 - wi);
        ...
        bjmh = bhbc[4*(i) + iboffBC - 2 ];
        bjms = bhbc[4*(i) + iboffBC - 1 ];
        bjps = bhbc[4*(i) + iboffBC + 1 ];
        bjph = bhbc[4*(i) + iboffBC + 2 ];
...
{
    return 1.0*(-1.33333333333333*t + 0.666666666666667*x - 1.33333333333333)*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0));
}

double GtA(double x, double t)
{
    return -0.166666666666667*(-5.33333333333333*t + 2.66666666666667*x - 5.33333333333333)*(0.666666666666667*t 
            - 0.333333333333333*x + 0.666666666666667)*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
            + 0.0555555555555556*(-5.33333333333333*t + 2.66666666666667*x - 5.33333333333333)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
            + 0.5*(-2.66666666666667*t + 1.33333333333333*x - 2.66666666666667)*(0.1*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x) 
            + 0.01*cos(0.1*x)*cos(0.1*x) + 1 - 0.005*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*sin(0.1*x))*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
            - 0.444444444444444*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
            - 0.111111111111111*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
            + 0.5*(0.1*(-1.33333333333333*t + 0.666666666666667*x - 1.33333333333333)*(0.666666666666667*t 
            - 0.333333333333333*x + 0.666666666666667)*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
            *cos(0.1*x) - 0.005*(-1.33333333333333*t + 0.666666666666667*x - 1.33333333333333)*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
            *sin(0.1*x) + 0.0666666666666667*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x))*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0));
}

double Fluxhdiff(double x, double t)
{
    return 0.5*(1.33333333333333*t - 0.666666666666667*x + 1.33333333333333)*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0));
}

double FluxGdiff(double x, double t)
{
    return -0.166666666666667*(-0.444444444444444*t + 0.222222222222222*x - 0.444444444444444)
        *exp(-0.833333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) - 0.166666666666667*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *(3.33333333333333*t - 1.66666666666667*x + 3.33333333333333)*exp(-0.833333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
        + 0.025*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(2.66666666666667*t - 1.33333333333333*x 
        + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x) 
        + 0.5*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(-0.166666666666667
        *(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)
        *exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.5*(0.1*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x) + 0.01*cos(0.1*x)*cos(0.1*x) + 1 - 0.005*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
        *sin(0.1*x))*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.0555555555555556*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)))
        *exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) - 0.0025*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*sin(0.1*x) + 4.905*(1.33333333333333*t - 0.666666666666667*x + 1.33333333333333)
        *exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.5*(-0.166666666666667*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.222222222222222*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        + 0.5*(1.33333333333333*t - 0.666666666666667*x + 1.33333333333333)*(0.1*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x) + 0.01*cos(0.1*x)*cos(0.1*x) + 1 - 0.005*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))
        *sin(0.1*x))*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.111111111111111*(2.66666666666667*t - 1.33333333333333*x + 2.66666666666667)
        *exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) + 0.5*(0.1*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x) - 0.015*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)
        *exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*sin(0.1*x) - 0.002*sin(0.1*x)*cos(0.1*x) - 0.0338333333333333*exp(-0.166666666666667
        *(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x))*exp(-0.333333333333333*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)))*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0)) 
        - 0.00833333333333333*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x);
}

double SourceG(double x, double t)
{
    return 0.00125*(0.666666666666667*t - 0.333333333333333*x + 0.666666666666667)*exp(-0.666666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*sin(0.1*x) 
        - 0.00025*exp(-0.5*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*sin(0.1*x)*cos(0.1*x) - 0.981*exp(-0.166666666666667*(-2.0*t + x - 2.0)*(-2.0*t + x - 2.0))*cos(0.1*x);
}


//include BCs
void evolve(double *Ghbc, double *hhbc, double *whbc, double *ubc,double *bedhbc, int nGhhbc, int nubc, int nbhc, int nGhBC, int unBC, int bnBC, double g, double dx, double dt, int n, double theta, double *newG, double *newh, double *x, double t)
{
    double idx = 1.0 / dx;  
	int i;
    ...
    bedai = 0.5*9*idx*idx*idx*(-bedhbc[4*i + (bnBC -1)]+ 3*bedhbc[4*i + (bnBC -1) + 1] - 3*bedhbc[4*i + (bnBC -1) + 3] + bedhbc[4*i + (bnBC -1) + 4]);
    bedbi = 0.25*9*idx*idx*(bedhbc[4*i + (bnBC -1)] - bedhbc[4*i + (bnBC -1)+1] - bedhbc[4*i + (bnBC -1) + 3] + bedhbc[4*i + (bnBC -1) + 4]);
    bedci = i8*idx*(bedhbc[4*i + (bnBC -1)] - 27*bedhbc[4*i + (bnBC -1) + 1] + 27*bedhbc[4*i + (bnBC -1) + 3]- bedhbc[4*i + (bnBC -1) + 4]);
    ...
    bedaip1 = 0.5*9*idx*idx*idx*(-bedhbc[4*(i+1) + (bnBC -1)]+ 3*bedhbc[4*(i+1) + (bnBC -1)+1] - 3*bedhbc[4*(i+1) + (bnBC -1)+3] + bedhbc[4*(i+1) + (bnBC -1) +4]);
    bedbip1 = 0.25*9*idx*idx*(bedhbc[4*(i+1) + (bnBC -1)] - bedhbc[4*(i+1) + (bnBC -1)+1] - bedhbc[4*(i+1) + (bnBC -1)+3] + bedhbc[4*(i+1) + (bnBC -1)+4]);
    bedcip1 = i8*idx*(bedhbc[4*(i+1) + (bnBC -1)] - 27*bedhbc[4*(i+1) + (bnBC -1)+1] + 27*bedhbc[4*(i+1) + (bnBC -1)+3]- bedhbc[4*(i+1) + (bnBC -1)+4]);
    ...
    for(i = 0;i < n;i++)
    {
        ...
        GS = GtA(x[i],t) + FluxGdiff(x[i],t) + SourceG(x[i],t);

        //printf("hchange : %d | %e \n ",i,- dt*idx*(foh - fih));
        //printf("Gchange : %d | %e \n ",i,- dt*idx*(foG - fiG) + dt*idx*(sourcer+sourcel + dx*sourcec));

		newh[i] = hhbc[3*(i) +nGhBC + 1] - dt*idx*(foh - fih) + dt*hS;
		newG[i] = Ghbc[3*(i) +nGhBC + 1] - dt*idx*(foG - fiG) + dt*idx*(sourcer+sourcel + dx*sourcec) + dt*GS;
...
void evolvewrapCONST(double *G, double *h,double *bhbc,double *hMbeg , double *hMend,double *wMbeg , double *wMend,double *GMbeg , double *GMend,double *uMbeg , double *uMend,double *hMbeg1 , double *hMend1,double *wMbeg1, double *wMend1,double *GMbeg1, double *GMend1,double *uMbeg1, double *uMend1,double g, double dx, double dt, int n, int nGhBC, int unBC,int bnBC, int nGhhbc, int nubc, int nbhbc , double theta, double *hhbc, double *whbc,double *Ghbc,double *ubc, double *x, double t)
{
    ...
    getufromG(h,G, bhbc,hMbeg,hMend,GMbeg,GMend,uMbeg,uMend,wMbeg,wMend,theta,dx,n,u_length,nGhBC,unBC,bnBC,nGhhbc,nubc,nbhbc,ubc,hhbc,Ghbc,whbc);
    evolve(Ghbc, hhbc,whbc, ubc, bhbc,nGhhbc,nubc,nbhbc,nGhBC,unBC,bnBC,g, dx,dt,n, theta ,Gp, hp,x,t);


    getufromG(hp,Gp, bhbc,hMbeg1,hMend1,GMbeg1,GMend1,uMbeg1,uMend1,wMbeg1,wMend1,theta,dx,n,u_length,nGhBC,unBC,bnBC,nGhhbc,nubc,nbhbc,ubc,hhbc,Ghbc,whbc);
    evolve(Ghbc, hhbc,whbc, ubc, bhbc,nGhhbc,nubc,nbhbc,nGhBC,unBC,bnBC,g, dx,dt,n, theta ,Gpp, hpp,x,t+ dt);
