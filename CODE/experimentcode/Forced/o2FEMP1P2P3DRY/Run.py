...
wdir = "../../../../../data/raw/Forced/P1P2P3BedFEM/ALL1/"  
...
"""
wdir = "../../../../../data/raw/Forced/P1P2P3BedFEM/Temporal/"  

if not os.path.exists(wdir):
    os.makedirs(wdir)

largej = 15
for j in range(largej,-1,-1):
    a0 = 10.0
    a1 = 2.0
    a2 = 0.5
    a3 = 3.0
...
"""
#FEM check
wdir = "../../../../../data/raw/Forced/P1P2P3BedFEM/FEMt1/"  
...
for j in range(16):
    ...
    getufromG(h_c, G_c, bhbc_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,uMbeg_c,uMend_c,wMbeg_c,wMend_c,theta,dx,n,2*n +1,GhnBC,unBC,nGhhbc,nubc,nbhbc,ubc_c,hhbc_c,Ghbc_c,whbc_c)
