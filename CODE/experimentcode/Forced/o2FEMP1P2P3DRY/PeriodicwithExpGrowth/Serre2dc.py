...
def evolvewrapForcing(G, h, bed, hMbeg, hMend, wMbeg, wMend, GMbeg, GMend, uMbeg, uMend, bMbeg, bMend, hMbeg1, hMend1, wMbeg1, wMend1, GMbeg1, GMend1, uMbeg1, uMend1, g, dx, dt, n, nGhBC, unBC, bnBC, nGhhbc, nubc, nbhc, theta, hhbc, whbc, Ghbc, bedhbc, ubc, x, t):
    return _Serre2dc.evolvewrapForcing(G, h, bed, hMbeg, hMend, wMbeg, wMend, GMbeg, GMend, uMbeg, uMend, bMbeg, bMend, hMbeg1, hMend1, wMbeg1, wMend1, GMbeg1, GMend1, uMbeg1, uMend1, g, dx, dt, n, nGhBC, unBC, bnBC, nGhhbc, nubc, nbhc, theta, hhbc, whbc, Ghbc, bedhbc, ubc, x, t)
