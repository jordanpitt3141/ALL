...
double GtA(double x, double t)
{
    return 2.1*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(0.7*t)*cos(3*x) 
        ...
        + (exp(0.5*t)*sin(2*x) + 10.0)*(-6.25*exp(0.5*t)*sin(2*x)*cos(5*x) 
        - 5.0*exp(0.5*t)*sin(5*x)*cos(2*x))*exp(0.7*t)*cos(3*x) 
        + 0.7*(exp(0.5*t)*sin(2*x) + 10.0)*(-25*(exp(0.5*t)*sin(2*x) + 10.0)*cos(5*x)/2 
        - 10*exp(0.5*t)*sin(5*x)*cos(2*x) + 25*sin(5*x)*sin(5*x) + 1)*exp(0.7*t)*cos(3*x) 
        + 6.0*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.7*t)*sin(2*x)*sin(3*x)*cos(2*x) 
        + 0.5*(-25*(exp(0.5*t)*sin(2*x) + 10.0)*cos(5*x)/2 - 10*exp(0.5*t)*sin(5*x)*cos(2*x) 
        + 25*sin(5*x)*sin(5*x) + 1)*exp(1.2*t)*sin(2*x)*cos(3*x);
}
...
double FluxGdiff(double x, double t)
{
    return -36.0*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(3*x)*cos(3*x) 
        - 45*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(3*x)*sin(3*x)*sin(5*x) 
        + 75*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(3*x)*cos(3*x)*cos(5*x) 
        + 45*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(5*x)*cos(3*x)*cos(3*x)
        ...
        + 60*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.9*t)*sin(3*x)*sin(5*x)*cos(2*x)*cos(3*x) 
        ...
        + (exp(0.5*t)*sin(2*x) + 10.0)*(-25*(exp(0.5*t)*sin(2*x) + 10.0)*cos(5*x)/2 - 10*exp(0.5*t)*sin(5*x)*cos(2*x) + 25*sin(5*x)*sin(5*x) + 1)*exp(0.7*t)*cos(3*x))*exp(0.7*t)*sin(3*x)
        + (-9*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(0.7*t)*sin(3*x) 
        - 12*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.2*t)*sin(2*x)*sin(3*x) 
        + 36*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.2*t)*cos(2*x)*cos(3*x) 
        + (exp(0.5*t)*sin(2*x) + 10.0)*(125*(exp(0.5*t)*sin(2*x) + 10.0)*sin(5*x)/2 
        + 20*exp(0.5*t)*sin(2*x)*sin(5*x) 
        - 75*exp(0.5*t)*cos(2*x)*cos(5*x) 
        + 250*sin(5*x)*cos(5*x))*exp(0.7*t)*cos(3*x) 
        - 3*(exp(0.5*t)*sin(2*x) + 10.0)*(-25*(exp(0.5*t)*sin(2*x) + 10.0)*cos(5*x)/2 
        - 10*exp(0.5*t)*sin(5*x)*cos(2*x) + 25*sin(5*x)*sin(5*x) + 1)*exp(0.7*t)*sin(3*x) 
        + 24*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.7*t)*sin(3*x)*cos(2*x)*cos(2*x) 
        + 2*(-25*(exp(0.5*t)*sin(2*x) + 10.0)*cos(5*x)/2 
        - 10*exp(0.5*t)*sin(5*x)*cos(2*x) 
        + 25*sin(5*x)*sin(5*x) + 1)*exp(1.2*t)*cos(2*x)*cos(3*x))*exp(0.7*t)*cos(3*x);
}

double SourceG(double x, double t)
{
    return 75*(exp(0.5*t)*sin(2*x) + 10.0)*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(3*x)*cos(3*x)*cos(5*x)/2 
        - 125*(exp(0.5*t)*sin(2*x) + 10.0)*exp(1.4*t)*sin(5*x)*cos(3*x)*cos(3*x)*cos(5*x) - 5*(9.81*exp(0.5*t)*sin(2*x) + 98.1)*sin(5*x);
}
