...
def evolvewrapForcing(G, h, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, g, dx, dt, n, nGhBC, unBC, nGhhbc, nubc, theta, hhbc, Ghbc, ubc):
    return _Serre2dc.evolvewrapForcing(G, h, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, g, dx, dt, n, nGhBC, unBC, nGhhbc, nubc, theta, hhbc, Ghbc, ubc)
