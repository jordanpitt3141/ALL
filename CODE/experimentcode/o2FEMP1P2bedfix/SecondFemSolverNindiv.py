...
def testsolSin(x):
    ...
    for i in range(n):
        ...
        h[i] = sin(10*xp) + 3
        bed[i] = sin(7*xp)
        G[i] = u[i]*h[i] - 30*(h[i])**2*cos(10*xp)*cos(3*xp) + 3*(h[i])**3*sin(3*xp) + u[i]*h[i]*(7*cos(7*xp))**2
...
def FEM2Assem(h,b,G,hbeg,hend,bbeg,bend,Gbeg,Gend,umh,uph,theta,dx):
    ...
    for i in range(1,n-1):
        ...
        LHSa11 = uhintia11 + h3uxintia11 + hbxbxuva11 
        LHSa12 = uhintia12 + h3uxintia12 + hbxbxuva12 
        LHSa13 = uhintia13 + h3uxintia13 + hbxbxuva13 
        LHSa21 = uhintia21 + h3uxintia21 + hbxbxuva21 
        LHSa22 = uhintia22 + h3uxintia22 + hbxbxuva22
        LHSa23 = uhintia23 + h3uxintia23 + hbxbxuva23
        LHSa31 = uhintia31 + h3uxintia31 + hbxbxuva31 
        LHSa32 = uhintia32 + h3uxintia32 + hbxbxuva32 
        LHSa33 = uhintia33 + h3uxintia33 + hbxbxuva33 
