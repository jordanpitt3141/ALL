...
def testsolSin(x):
    ...
    for i in range(n):
        ...
        G[i] = u[i]*h[i] - 30*(h[i])**2*cos(10*xp)*cos(3*xp) + 3*(h[i])**3*sin(3*xp) \
                +   u[i]*h[i]*10*cos(10*xp)*7*cos(7*xp) + 0.5*u[i]*h[i]*h[i]*(-49*sin(7*xp))
...
def FEM2Assem(h,b,G,hbeg,hend,bbeg,bend,Gbeg,Gend,umh,uph,theta,dx):
    ...
    for i in range(1,n-1):
        ...
        LHSa11 = uhintia11 + h3uxintia11 + h2bxuxva11 + h2bxuvxa11 
        LHSa12 = uhintia12 + h3uxintia12 + h2bxuxva12 + h2bxuvxa12
        LHSa13 = uhintia13 + h3uxintia13 + h2bxuxva13 + h2bxuvxa13
        LHSa21 = uhintia21 + h3uxintia21 + h2bxuxva21 + h2bxuvxa21
        LHSa22 = uhintia22 + h3uxintia22 + h2bxuxva22 + h2bxuvxa22
        LHSa23 = uhintia23 + h3uxintia23 + h2bxuxva23 + h2bxuvxa23
        LHSa31 = uhintia31 + h3uxintia31 + h2bxuxva31 + h2bxuvxa31
        LHSa32 = uhintia32 + h3uxintia32 + h2bxuxva32 + h2bxuvxa32 
        LHSa33 = uhintia33 + h3uxintia33 + h2bxuxva33 + h2bxuvxa33
