...
def getufromG(h, G, bed, hebeg, heend, Gebeg, Geend, uebeg, ueend, bedbeg, bedend, theta, dx, n, m, nBC, nhbc, u, hhbc, Ghbc, bedhbc):
    return _Serre2dc.getufromG(h, G, bed, hebeg, heend, Gebeg, Geend, uebeg, ueend, bedbeg, bedend, theta, dx, n, m, nBC, nhbc, u, hhbc, Ghbc, bedhbc)
...
def evolvewrap(G, h, bed, hebeg, heend, Gebeg, Geend, uebeg, ueend, bedbeg, bedend, g, dx, dt, n, nBCs, theta, ubc, hhbc, Ghbc, bedhbc):
    return _Serre2dc.evolvewrap(G, h, bed, hebeg, heend, Gebeg, Geend, uebeg, ueend, bedbeg, bedend, g, dx, dt, n, nBCs, theta, ubc, hhbc, Ghbc, bedhbc)
