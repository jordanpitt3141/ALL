 ...
 extern void evolvewrap(double *G, double *h,double *hebeg , double *heend ,double *Gebeg , double *Geend,double *uebeg , double *ueend, double g, double dx, double dt, int n, int nhbc, int nubc, double theta);
 extern void getufromG(double *h, double *G, double *hebeg, double *heend, double *Gebeg, double *Geend,double *uebeg, double *ueend, double theta, double dx , int n, int nu, int nhbc, int nubc , double *u, double *hhbc, double *Ghbc);
