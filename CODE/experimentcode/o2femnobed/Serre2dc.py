...
def evolvewrap(G, h, hebeg, heend, Gebeg, Geend, uebeg, ueend, g, dx, dt, n, nhbc, nubc, theta):
    return _Serre2dc.evolvewrap(G, h, hebeg, heend, Gebeg, Geend, uebeg, ueend, g, dx, dt, n, nhbc, nubc, theta)
