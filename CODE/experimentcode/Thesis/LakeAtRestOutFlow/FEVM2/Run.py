...
def LakeAtRestO(x,a0,a1,a2,g,dx,xs,xe):
    n = len(x)
    h = zeros(n)
    w = zeros(n)
    b= zeros(n)
...
def LakeAtRest(x,a0,a1,a2,g,dx,xs,xe):
    n = len(x)
    h = zeros(n)
    w = zeros(n)
    b= zeros(n)
...
#Forcing Problem    
wdir = "../../../../../../../data/2018/raw/Thesis/LakeAtRest/DryN/FEVM2/"
...
for ki in range(10,11):
    ...
    wregs =  -pi/2.0/a1 - 2*wl/5.0   
    wrege =  -pi/2.0/a1 + 2*wl/5.0   
    ...
    h,u,G,b,w =  LakeAtRest(x,a0,a1,a2,g,dx,wregs,wrege)
    hMbeg,uMbeg,GMbeg,bta,wMbeg =  LakeAtRest(xhMbeg,a0,a1,a2,g,dx,wregs,wrege)
    hMend,uMend,GMend,bta,wMend =  LakeAtRest(xhMbeg,a0,a1,a2,g,dx,wregs,wrege)
    
    
    hta,uta,Gta,bMbeg,wta =LakeAtRest(xbMbeg,a0,a1,a2,g,dx,wregs,wrege)
    hta,uta,Gta,bMend,wta =LakeAtRest(xbMend,a0,a1,a2,g,dx,wregs,wrege)
    ...
    h0C,u0C,G0C,b0C,w0c =  LakeAtRest(xbegC,a0,a1,a2,g,dx,wregs,wrege)
    h1C,u1C,G1C,b1C,w1c =  LakeAtRest(xendC,a0,a1,a2,g,dx,wregs,wrege)
