...
#Forcing Problem    
wdir = "../../../../data/2018/raw/Thesis/TestRecon/Dry/FEVM2/"
...
for ki in range(11,12):
    ...
    ReconLin(h_c, hMbeg_c,hMend_c,n,nBC,nbc,theta,  hbc_c)
    ReconLin(u_c, uMbeg_c,uMend_c,n,nBC,nbc,theta,  ubc_c)
    ReconLin(G_c, GMbeg_c,GMend_c,n,nBC,nbc,theta,  Gbc_c)
    ReconLin(b_c, bMbeg_c,bMend_c,n,nBC,nbc,theta,  bbc_c)
    ReconLin(w_c, wMbeg_c,wMend_c,n,nBC,nbc,theta,  wbc_c)
