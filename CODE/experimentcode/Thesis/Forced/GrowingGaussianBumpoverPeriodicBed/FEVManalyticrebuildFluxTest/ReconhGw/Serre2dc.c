...
//include BCs
void evolveForce(double *hbc, double *Gbc, double *wbc,double g, double dx, double dt, int n, int hnBC, int hnbc, double *newG, double *newh, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double a9)
{
    double idx = 1.0 / dx;  
	int i;
    ...
    for(i = 0;i < n;i++)
    {
		...
		newG[i] = Gbc[hnBC + 3*(i) + 1] - dt*idx*(foG - fiG) + dt*idx*(dx*sourcec  )+ dt*GS; //+sourcer  + sourcel
...
void evolvewrapForcingANA(double *h, double *G, double *b,double *hMbeg, double *hMend,double *GMbeg, double *GMend,double *wMbeg, double *wMend,int n, int hnBC , int hnbc,double theta,double dx, double dt, double g, double *x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7, double a8, double a9)
{
    ...
    evolveForce(hbc,Gbc,wbc,g, dx,dt,n,hnBC,hnbc,Gp, hp,x,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9); 
    ...
    evolveForce(hbc,Gbc,wbc,g, dx,dt,n,hnBC,hnbc,Gpp, hpp,x,t + dt,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9); 
