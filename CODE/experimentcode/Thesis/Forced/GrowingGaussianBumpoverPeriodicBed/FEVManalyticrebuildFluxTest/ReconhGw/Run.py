...
#Forcing Problem    
wdir = "../../../../data/2018/raw/Thesis/ForcedANReconLonger/Dry/FEVM2/"
...
for ki in range(3,18):
    ...
    width = 2*(2*pi/a9) #0.25*(2*pi/a9)#2*(2*pi/a9)
    ...
    hMbeg,uta,GMbeg,bhMbeg = ForcedbedM(xMbeg,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
    wMbeg  = hMbeg + bhMbeg
    hMend,uta,GMend,bhMend = ForcedbedM(xMend,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
    wMend  = hMend + bhMend
