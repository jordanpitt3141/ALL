...
#Forcing Problem    
wdir = "../../../../data/2018/raw/Thesis/ForcedANAReconALLLong/Dry/FEVM2/"
...
for ki in range(3,16):
    ...
    hMbeg,uta,GMbeg,bhMbeg = ForcedbedM(xhMbeg,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
    wMbeg  = hMbeg + bhMbeg
    hMend,uta,GMend,bhMend = ForcedbedM(xhMend,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
    wMend  = hMend + bhMend
