...
#Forcing Problem    
wdir = "../../../../data/2018/raw/Thesis/Forced1/WetNobedGrow/FEVM2nozero/"
...
for ki in range(3,15):
    ...
    while t < endt:  
        htA,ubct,GtA,btA,wtA = ForcedbedM(xubc,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
        htA,ubctpdt,GtA,btA,wtA = ForcedbedM(xubc,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g,dx)
        
        ubct_c = copyarraytoC(ubct)
        ubctpdt_c = copyarraytoC(ubctpdt)
        
        evolvewrapForcingUANA(G_c,h_c,b_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c ,GMend_c,uMbeg_c,uMend_c,bMbeg_c,bMend_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c,GMend_c,uMbeg_c,uMend_c,g,dx,dt,n,GhnBC,unBC,bnBC,nGhhbc,nubc,nbhbc,theta,hhbc_c, whbc_c,Ghbc_c,bhbc_c,ubc_c,x_c,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,ubct_c,ubctpdt_c)
    ...
    hibcC = copyarrayfromC(hhbc_c,nGhhbc)
    wibcC = copyarrayfromC(whbc_c,nGhhbc)
    GibcC = copyarrayfromC(Ghbc_c,nGhhbc)
