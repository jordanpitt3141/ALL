...
void evolve(double *G, double *h, double *u, double g, double dx, double dt, int nBC, int n,double *nG, double *nh, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double a9)
{
    double hS, GS;
    ...
    for (i = nBC ; i < n +nBC;i++)
    {
        ...
        hS = ht(x[i- nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g) + Fluxhdiff(x[i- nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g);

        GS = Gt(x[i- nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g) + FluxGdiff(x[i- nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g) + SourceG(x[i- nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,g);
...
void evolvewrap(double *G, double *h, double *h0, double *h1, double *u0, double *u1, double g, double dx, double dt, int nBC, int n, int nBCs, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8,double a9)
{
    ...
    evolve(Gbc,hbc,ubc,g,dx,dt,nBC,n,G,h,x,t,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9);
