...
#Forcing Problem    
wdir = "../../../../../../../data/raw/Forced/P1P2P3BedFEMSplit/GaussBedGrowAll/Test123/"  
...
for j in range(12,13):
    ...
    hMbeg = a0*ones(GhnBC)
    hMend = a0*ones(GhnBC)
    wMbeg = hMbeg + a8*sin(a8*xhuMbeg)
    wMend = hMend + a8*sin(a8*xhuMend)
    uMbeg = zeros(unBC)
    uMend = zeros(unBC)
    GMbeg = zeros(GhnBC)
    GMend = zeros(GhnBC)
    ...
    bMbeg = a8*sin(a8*xbMbeg)
    bMend = a9*sin(a9*xbMend)
