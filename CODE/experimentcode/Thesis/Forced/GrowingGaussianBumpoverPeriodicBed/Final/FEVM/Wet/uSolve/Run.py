...
#Forcing Problem    
wdir = "../../../../../../../data/2018/raw/Thesis/ForcedFin/Wet/uSolve/FEVM2/"
...
for ki in range(3,13):
    ...
    uhbcC = []
    for i in range(len(xG)):
        uhbcC.append(ubcC[2*i] * hbcC[3*i])
        uhbcC.append(ubcC[2*i +1] * hbcC[3*i + 1])
        uhbcC.append(ubcC[2*i +2] * hbcC[3*i + 2])
