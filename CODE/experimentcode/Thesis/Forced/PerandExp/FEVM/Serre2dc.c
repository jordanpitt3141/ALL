...
double ht(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double g)
{
    return a1*a3*pow(E,a3*t)*sin(a2*x);
}

double Gt(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double g)
{
    return (3*a1*a3*a4*pow(a5,2)*pow(E,a3*t + a6*t)*cos(a5*x)*sin(a2*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2) + a4*pow(a5,2)*a6*pow(E,a6*t)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),3) + 
      6*pow(a1,2)*a2*a3*a4*a5*pow(E,2*a3*t + a6*t)*cos(a2*x)*sin(a2*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a5*x) + 
      3*a1*a2*a4*a5*(a3 + a6)*pow(E,a3*t + a6*t)*cos(a2*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*sin(a5*x))/3. + 
   a4*pow(E,a6*t)*cos(a5*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*(a1*a2*a3*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) - (a1*a3*a7*pow(a8,2)*pow(E,a3*t)*sin(a2*x)*sin(a8*x))/2.) + 
   a1*a3*a4*pow(E,a3*t + a6*t)*cos(a5*x)*sin(a2*x)*(1 + a1*a2*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) + pow(a7,2)*pow(a8,2)*pow(cos(a8*x),2) - (a7*pow(a8,2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x))/2.) + 
   a4*a6*pow(E,a6*t)*cos(a5*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*(1 + a1*a2*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) + pow(a7,2)*pow(a8,2)*pow(cos(a8*x),2) - 
      (a7*pow(a8,2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x))/2.);
}

double Fluxhdiff(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double g)
{
    return a1*a2*a4*pow(E,a3*t + a6*t)*cos(a2*x)*cos(a5*x) - a4*a5*pow(E,a6*t)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a5*x);
}

double FluxGdiff(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double g)
{
    return a1*a2*pow(E,a3*t)*g*cos(a2*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x)) - pow(a4,2)*pow(a5,2)*a7*a8*pow(E,2*a6*t)*pow(cos(a5*x),2)*cos(a8*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2) - 
   2*a1*a2*pow(a4,2)*a5*a7*a8*pow(E,a3*t + 2*a6*t)*cos(a2*x)*cos(a5*x)*cos(a8*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a5*x) - 
   (4*pow(a4,2)*pow(a5,3)*pow(E,2*a6*t)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),3)*sin(a5*x))/3. - 
   2*a1*a2*pow(a4,2)*pow(a5,2)*pow(E,a3*t + 2*a6*t)*cos(a2*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*pow(sin(a5*x),2) + 
   pow(a4,2)*pow(a5,2)*a7*a8*pow(E,2*a6*t)*cos(a8*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*pow(sin(a5*x),2) + 
   pow(a4,2)*a5*a7*pow(a8,2)*pow(E,2*a6*t)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*sin(a5*x)*sin(a8*x) - 
   a4*a5*pow(E,a6*t)*sin(a5*x)*((a4*pow(a5,2)*pow(E,a6*t)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),3) + 3*a1*a2*a4*a5*pow(E,a3*t + a6*t)*cos(a2*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*sin(a5*x))/3. + 
      a4*pow(E,a6*t)*cos(a5*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*(1 + a1*a2*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) + pow(a7,2)*pow(a8,2)*pow(cos(a8*x),2) - 
         (a7*pow(a8,2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x))/2.)) + a4*pow(E,a6*t)*cos(a5*x)*
    ((6*a1*a2*a4*pow(a5,2)*pow(E,a3*t + a6*t)*cos(a2*x)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2) + 
         6*pow(a1,2)*pow(a2,2)*a4*a5*pow(E,2*a3*t + a6*t)*pow(cos(a2*x),2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a5*x) - 
         3*a1*pow(a2,2)*a4*a5*pow(E,a3*t + a6*t)*sin(a2*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*sin(a5*x) - a4*pow(a5,3)*pow(E,a6*t)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),3)*sin(a5*x))/3. + 
      a4*pow(E,a6*t)*cos(a5*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*(-(a1*pow(a2,2)*a7*a8*pow(E,a3*t)*cos(a8*x)*sin(a2*x)) - (a7*pow(a8,3)*cos(a8*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x)))/2. - 
         (3*a1*a2*a7*pow(a8,2)*pow(E,a3*t)*cos(a2*x)*sin(a8*x))/2. - 2*pow(a7,2)*pow(a8,3)*cos(a8*x)*sin(a8*x)) + 
      a1*a2*a4*pow(E,a3*t + a6*t)*cos(a2*x)*cos(a5*x)*(1 + a1*a2*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) + pow(a7,2)*pow(a8,2)*pow(cos(a8*x),2) - (a7*pow(a8,2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x))/2.) - 
      a4*a5*pow(E,a6*t)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a5*x)*(1 + a1*a2*a7*a8*pow(E,a3*t)*cos(a2*x)*cos(a8*x) + pow(a7,2)*pow(a8,2)*pow(cos(a8*x),2) - 
         (a7*pow(a8,2)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x))/2.));
}

double SourceG(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8, double g)
{
    return a7*a8*g*cos(a8*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x)) + pow(a4,2)*pow(a7,2)*pow(a8,3)*pow(E,2*a6*t)*pow(cos(a5*x),2)*cos(a8*x)*(a0 + a1*pow(E,a3*t)*sin(a2*x))*sin(a8*x) + 
   (pow(a4,2)*a5*a7*pow(a8,2)*pow(E,2*a6*t)*cos(a5*x)*pow(a0 + a1*pow(E,a3*t)*sin(a2*x),2)*sin(a5*x)*sin(a8*x))/2.;
}


//include BCs
void evolveForce(double *Ghbc, double *hhbc, double *whbc, double *ubc,double *bedhbc, int nGhhbc, int nubc, int nbhc, int nGhBC, int unBC, int bnBC, double g, double dx, double dt, int n, double theta, double *newG, double *newh, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8)
{
    double idx = 1.0 / dx;  
	int i;
   ...
   //Figure out how the interior numberings work.
    ...
    for(i = 0;i < n;i++)
    {
        ...
        hS = ht(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,g) + Fluxhdiff(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,g);

        GS = Gt(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,g) + FluxGdiff(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,g) + SourceG(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,a8,g);
...
void evolvewrapForcing(double *G, double *h,double *bed,double *hMbeg , double *hMend,double *wMbeg , double *wMend,double *GMbeg , double *GMend,double *uMbeg , double *uMend, double *bMbeg, double *bMend,double *hMbeg1, double *hMend1,double *wMbeg1, double *wMend1,double *GMbeg1, double *GMend1,double *uMbeg1, double *uMend1, double g, double dx, double dt, int n, int nGhBC, int unBC,int bnBC, int nGhhbc, int nubc, int nbhc , double theta, double *hhbc, double *whbc,double *Ghbc,double *bedhbc,double *ubc, double *x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7,double a8)
{
    ...
    evolveForce(Ghbc, hhbc,whbc, ubc, bedhbc,nGhhbc,nubc,nbhc,nGhBC,unBC,bnBC,g, dx,dt,n, theta ,Gp, hp,x,t,a0,a1,a2,a3,a4,a5,a6,a7,a8);
    ...
    evolveForce(Ghbc, hhbc,whbc, ubc, bedhbc,nGhhbc,nubc,nbhc,nGhBC,unBC,bnBC,g, dx,dt,n, theta ,Gpp, hpp,x,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,a8);
