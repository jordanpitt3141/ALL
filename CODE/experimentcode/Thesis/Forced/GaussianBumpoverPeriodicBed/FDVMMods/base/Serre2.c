...
void evolveDRY(double *hMbc, double *GMbc, double *wMbc, double *bMbc, double *duEbc, double *uEbc, double *ddbCbc, int nMBC, int nEBC, int nCBC, int n,int nMbc, int nEbc, int nCbc, double dx, double dt, double g, double theta, double *hblank, double *Gblank, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7)
{
    ...
    for(i =nCBC; i < n + nCBC;i++)
    {
        ...
        hS = ht(x[i- nCBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + Fluxhdiff(x[i- nCBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        GS = Gt(x[i- nCBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + FluxGdiff(x[i- nCBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + SourceG(x[i- nCBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);
...
//UNFINISHED~~~
	...
	evolveDRY(hMbc,GMbc,wMbc,bMbc,duEbc,uEbc,ddbCbc,nMBC,nEBC,nCBC,n,nMbc,nEbc,nCbc,dx,dt,g,theta,hp,Gp,x,t,a0,a1,a2,a3,a4,a5,a6,a7);
	...
	evolveDRY(hMbc,GMbc,wMbc,bMbc,duEbc,uEbc,ddbCbc,nMBC,nEBC,nCBC,n,nMbc,nEbc,nCbc,dx,dt,g,theta,hpp,Gpp,x,t+ dt,a0,a1,a2,a3,a4,a5,a6,a7);
