...
def ReconValues(h, G, bed, hMbeg, GMbeg, wMbeg, bMbeg, duEbeg, uEbeg, ddbCbeg, hMend, GMend, wMend, bMend, duEend, uEend, ddbCend, nMBC, nEBC, nCBC, n, nMbc, nEbc, nCbc, hMbc, GMbc, wMbc, bMbc, duEbc, uEbc, ddbCbc, dx, theta):
    return _Serre2.ReconValues(h, G, bed, hMbeg, GMbeg, wMbeg, bMbeg, duEbeg, uEbeg, ddbCbeg, hMend, GMend, wMend, bMend, duEend, uEend, ddbCend, nMBC, nEBC, nCBC, n, nMbc, nEbc, nCbc, hMbc, GMbc, wMbc, bMbc, duEbc, uEbc, ddbCbc, dx, theta)
ReconValues = _Serre2.ReconValues
