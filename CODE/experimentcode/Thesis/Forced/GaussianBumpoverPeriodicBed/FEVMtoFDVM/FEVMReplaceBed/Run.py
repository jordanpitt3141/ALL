...
#Forcing Problem    
wdir = "../../../../../../../data/2018/raw/Thesis/ForcedFin/Dry/P2P/FDEVMT/r1/"
...
for ki in range(3,13):
    ...
    while t < endt:  
        ...
        if close(t,wt,dt):
            ...
            ReconandSolve(h_c,G_c,b_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,wMbeg_c,wMend_c,bMbeg_c,bMend_c,uMbeg_c,uMend_c,n,hnBC,hnbc,bnBC,bnMBC,bnbc,unBC,unbc,theta,dx,dt,g,Gbc_c,hbc_c,wbc_c,ubc_c,bbc_c,bMbc_c)    
        ...
        evolvewrapForcingANA(h_c,G_c,b_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,wMbeg_c,wMend_c,bMbeg_c,bMend_c,uMbeg_c,uMend_c,n,hnBC,hnbc,bnBC,bnMBC,bnbc,unBC,unbc,theta,dx,dt,g,x_c,t,a0,a1,a2,a3,a4,a5,a6,a7);
        t = t + dt
        ts.append(t)
        print(t)
