...
void Fluxsplit(double *hbc, double *Gbc, double *wbc, double *bbc, double *bMbc, double *dbMbc, double *ddbCbc, double *ubc,double g, double dx, double dt, int n, int hnBC, int hnbc, int bnBC, int bnbc, int unBC, int unbc, int CnBC, int Cnbc, int *RegIndx, int m1 ,int RegIndxLen, double *FjhH, double *FjhG, double *SjG,double *SjHa, double *SjGa, double *x, double t, double a0, double a1, double a2, double a3, double a4, double a5, double a6, double a7)
{
    ...
    for (i =0;i<RegIndxLen;i++)
    {
        ...
        if(RegIndx[i*m1 +  3] == 1)
        {
           ...
           // printf("%d | %d | %d | %d | %d  \n \n",hIbeg,uIbeg,bIbeg,FIbeg,SIbeg   );
            ...
            evolveForce(hbc+ hIbeg,Gbc+ hIbeg,wbc+ hIbeg,bbc + bIbeg,bMbc+ hIbeg,dbMbc+ hIbeg,ddbCbc+ CIbeg,ubc+ uIbeg,g,dx,dt,RegIndx[i*m1 +  2],hnBC,hnbc,bnBC,bnbc,unBC,unbc,CnBC,Cnbc,FjhH + FIbeg,FjhG + FIbeg ,SjG + SIbeg,SjHa+ SIbeg,SjGa+ SIbeg,x+ SIbeg,t,a0,a1,a2,a3,a4,a5,a6,a7);
        }
    }
...
void FluxWrap(double *hbc, double *Gbc, double *wbc, double *bbc, double *bMbc, double *dbMbc, double *ddbCbc, double *ubc,double g, double dx, double dt, int n, int hnBC, int hnbc, int bnBC, int bnbc, int unBC, int unbc,int CnBC,int Cnbc, int *RegIndx, int m1 ,int RegIndxLen, double *x,double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7, double *hp, double *Gp)
{
    ...
    Fluxsplit(hbc,Gbc,wbc,bbc,bMbc,dbMbc,ddbCbc,ubc,g,dx,dt,n,hnBC,hnbc,bnBC,bnbc,unBC,unbc,CnBC,Cnbc,RegIndx,m1,RegIndxLen,FjhH,FjhG,SjG,SjHa,SjGa,x,t,a0,a1,a2,a3,a4,a5,a6,a7);
...
void evolvewrapForcingANA(double *h, double *G, double *b,double *hMbeg, double *hMend,double *GMbeg, double *GMend,double *wMbeg, double *wMend,double *bMbeg, double *bMend,double *dbMbeg, double *dbMend,double *ddbCbeg, double *ddbCend, double *uMbeg, double *uMend,int n, int hnBC , int hnbc, int bnBC, int bnMBC , int bnbc, int unBC , int unbc, int CnBC, int Cnbc,double theta,double dx, double dt, double g, double *x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7)
{
    ...
    FluxWrap(hbc,Gbc,wbc,bbc,bMbc,dbMbc,ddbCbc,ubc,g,dx,dt,n,hnBC,hnbc,bnBC,bnbc,unBC,unbc,CnBC,Cnbc,RegInd,m1 ,RegIndLen,x,t,a0,a1,a2,a3,a4,a5,a6,a7,hp,Gp);
    ...
    FluxWrap(hpbc,Gpbc,wpbc,bbc,bMbc,dbMbc,ddbCbc,upbc,g,dx,dt,n,hnBC,hnbc,bnBC,bnbc,unBC,unbc,CnBC,Cnbc,RegIndp,m1 ,RegIndLen,x,t + dt,a0,a1,a2,a3,a4,a5,a6,a7,hpp,Gpp);
