...
#Forcing Problem    
wdir = "/home/jp/Documents/PhD/project/data/2018/raw/Thesis/ForcedFin/Dry/P2P/FDEVMT/runDry2/"
...
for ki in range(3,13):
    ...
    while t < endt:  
        ...
        if close(t,wt,dt):
            ...
            ReconandSolve(h_c,G_c,b_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,wMbeg_c,wMend_c,bMbeg_c,bMend_c,dbMbeg_c,dbMend_c,ddbCbeg_c,ddbCend_c,uMbeg_c,uMend_c,n,hnBC,hnbc,bnBC,bnMBC,bnbc,unBC,unbc,CnBC,Cnbc,theta,dx,dt,g,Gbc_c,hbc_c,wbc_c,ubc_c,bbc_c,bMbc_c,dbMbc_c,ddbCbc_c)    
        ...
        evolvewrapForcingANA(h_c,G_c,b_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,wMbeg_c,wMend_c,bMbeg_c,bMend_c,dbMbeg_c,dbMend_c,ddbCbeg_c,ddbCend_c,uMbeg_c,uMend_c,n,hnBC,hnbc,bnBC,bnMBC,bnbc,unBC,unbc,CnBC,Cnbc,theta,dx,dt,g,x_c,t,a0,a1,a2,a3,a4,a5,a6,a7);
        t = t + dt
        ts.append(t)
        print(t)
    ...
    hAbc,uta,GAbc,bta= ForcedbedM(xhbc,t,a0,a1,a2,a3,a4,a5,a6,a7,g,dx)
    
    uhAbc = hAbc*uta
    
    hta,uAbc,Gta,bta= ForcedbedM(xubc,t,a0,a1,a2,a3,a4,a5,a6,a7,g,dx)
    ...
    hnorm = norm(hiC -hA, ord=1)/ norm(hA, ord=1)
    Gnorm = norm(GiC -GA, ord=1)/ norm(GA, ord=1)
    unorm = norm(uiC -uA, ord=1)/ norm(uA, ord=1)
    uhnorm = norm(uhiC -uhA, ord=1)/ norm(uhA, ord=1)
