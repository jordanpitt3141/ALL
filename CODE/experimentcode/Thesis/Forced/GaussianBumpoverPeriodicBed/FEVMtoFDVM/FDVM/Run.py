...
#Forcing Problem    
wdir = "/home/jp/Documents/PhD/project/data/2018/raw/Thesis/ForcedFin/Dry/P2P/FDEVMT/1st/Wet/"
...
for ki in range(10,11):
    ...
    while t < endt:  
        ...
        evolvewrapForcingANA(h_c,G_c,b_c,hMbeg_c,hMend_c,GMbeg_c,GMend_c,wMbeg_c,wMend_c,dbMbeg_c,dbMend_c,ddbCbeg_c,ddbCend_c,uMbeg_c,uMend_c,duMbeg_c,duMend_c,n,hnBC,hnbc,unBC,unbc,CnBC,Cnbc,theta,dx,dt,g,x_c,t,a0,a1,a2,a3,a4,a5,a6,a7);
        t = t + dt
        ts.append(t)
        print(t)
