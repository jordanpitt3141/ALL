...
def ReconandSolve(h, G, b, hMbeg, hMend, GMbeg, GMend, wMbeg, wMend, bMbeg, bMend, dbMbeg, dbMend, uMbeg, uMend, n, hnBC, hnbc, bnBC, bnMBC, bnbc, unBC, unbc, theta, dx, dt, g, Gbc, hbc, wbc, ubc, bbc, bMbc, dbMbc):
    return _Serre2dc.ReconandSolve(h, G, b, hMbeg, hMend, GMbeg, GMend, wMbeg, wMend, bMbeg, bMend, dbMbeg, dbMend, uMbeg, uMend, n, hnBC, hnbc, bnBC, bnMBC, bnbc, unBC, unbc, theta, dx, dt, g, Gbc, hbc, wbc, ubc, bbc, bMbc, dbMbc)
ReconandSolve = _Serre2dc.ReconandSolve

def evolvewrapForcingANA(h, G, b, hMbeg, hMend, GMbeg, GMend, wMbeg, wMend, bMbeg, bMend, dbMbeg, dbMend, uMbeg, uMend, n, hnBC, hnbc, bnBC, bnMBC, bnbc, unBC, unbc, theta, dx, dt, g, x, t, a0, a1, a2, a3, a4, a5, a6, a7):
    return _Serre2dc.evolvewrapForcingANA(h, G, b, hMbeg, hMend, GMbeg, GMend, wMbeg, wMend, bMbeg, bMend, dbMbeg, dbMend, uMbeg, uMend, n, hnBC, hnbc, bnBC, bnMBC, bnbc, unBC, unbc, theta, dx, dt, g, x, t, a0, a1, a2, a3, a4, a5, a6, a7)
