...
void evolve(double *G, double *h, double *u, double g, double dx, double dt,int n, int nBC, double *nh, double *nG, double *x, double t, double a0, double a1, double a2, double a3, double a4, double a5, double a6, double a7)
{
    ...
    for (i = nBC; i < n + nBC;i++)
    {
        ...
        hS = 0.5*(hxi1 + hxi2) + idx*(Fh(x[i-nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g) -  Fh(x[i-nBC] -0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g));

        GS = 0.5*(Gxi1 + Gxi2) + idx*(FG(x[i-nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g) -  FG(x[i-nBC] -0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g));
