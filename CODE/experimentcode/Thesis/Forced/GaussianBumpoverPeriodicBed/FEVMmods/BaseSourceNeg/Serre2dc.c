...
double SourceGN(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7, double g)
{
    ...
    return g*h*bx + 0.5*h*h*u*ux*bxx - h*u*u*bx*bxx ;
}
