...
double ha(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7, double g)
{

    return a0*x - a1*sqrt(a4)*sqrt(Pi/2.)*erf((a3 + a2*t - x)/(sqrt(2)*sqrt(a4)));
}

double Ga(double x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7, double g)
{
...
void evolve(double *G, double *h, double *u, double g, double dx, double dt,int n, int nBC, double *nh, double *nG, double *x, double t, double a0, double a1, double a2, double a3, double a4, double a5, double a6, double a7)
{
    ...
    for (i = nBC; i < n + nBC;i++)
    {
        ...
        // ## Integrate source term so its 3rd order in space
        //xi1, xi2

        xi1 = x[i - nBC] - 0.5*dx*(1.0 / sqrt(3));

        xi2 = x[i - nBC] + 0.5*dx*(1.0 / sqrt(3));

        hxi1 = ht(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g) + Fluxhdiff(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        Gxi1 = Gt(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g) + FluxGdiff(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g);


        hxi2 = ht(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g) + Fluxhdiff(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        Gxi2 = Gt(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g) + FluxGdiff(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g);
        ...
        */
        ...
        // Leave flux method unchanged, but average over ht and Gt
        /*
        xi1 = x[i - nBC] - 0.5*dx*(1.0 / sqrt(3));

        xi2 = x[i - nBC] + 0.5*dx*(1.0 / sqrt(3));

        hxi1 = ht(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        Gxi1 = Gt(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g);


        hxi2 = ht(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        Gxi2 = Gt(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        hS = 0.5*(hxi1 + hxi2) + Fluxhdiff(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        GS = 0.5*(Gxi1 + Gxi2) + FluxGdiff(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);
        */

        //More direct
        /*
        han =  idx*(ha(x[i - nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g) - ha(x[i - nBC] - 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g));

        hanp1 =  idx*(ha(x[i - nBC] + 0.5*dx,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,g) - ha(x[i - nBC] - 0.5*dx,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,g));
        ...
        Gan =  idx*(Ga(x[i - nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g) - Ga(x[i - nBC] - 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g));

        Ganp1 =  idx*(Ga(x[i - nBC] + 0.5*dx,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,g) - Ga(x[i - nBC] - 0.5*dx,t+dt,a0,a1,a2,a3,a4,a5,a6,a7,g));
        ...
        */
        ...
        /*
        // Standard unchanged course term, but does dx(qa^n+1 - qa^n) = q_t?   

        //hS = ht(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        //GS = Gt(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);
        ...
        /*
        Cell average check, correct order
        xi1 = x[i - nBC] - 0.5*dx*(1.0 / sqrt(3));
        ...
        Fourth Order, yes
        nh[i -nBC] = h[i] + dt*hS; // h[i] -dt*idx*(foh - fih) + hS;
        nG[i -nBC] = G[i] + dt*GS; //G[i] -dt*idx*(foG -fiG) + GS;
        */

        /* Best MEthod Not converting to midpoints
        xi1 = x[i - nBC] - 0.5*dx*(1.0 / sqrt(3));
        ...
        hSfxph = Fh(x[i - nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        GSfxph = FG(x[i - nBC] + 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g);


        hSfxmh = Fh(x[i - nBC] - 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        GSfxmh = FG(x[i - nBC] - 0.5*dx,t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        hFx = Fluxhdiff(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);
        GFx = FluxGdiff(x[i-nBC],t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        nh[i -nBC] = h[i] + dt*hSt -dt*idx*((foh-hSfxph) - (fih - hSfxmh));
        nG[i -nBC] = G[i] + dt*GSt -dt*idx*((foG-GSfxph) - (fiG - GSfxmh));
        */




        // check fluxes are right


        //nh[i -nBC] = h[i] + dt*hSt -dt*idx*((foh) - (fih )) + dt*hFx;
        //nG[i -nBC] = G[i] + dt*GSt -dt*idx*((foG) - (fiG )) + dt*GFx ;
    ...
    for(i =0;i<n;i++)
    {
        ...
        GS = Gt(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + FluxGdiff(x[i],t,a0,a1,a2,a3,a4,a5,a6,a7,g); 
    ...
    midpt2ca(nhm ,dx ,n, nh);
    midpt2ca(nGm ,dx ,n, nG);
