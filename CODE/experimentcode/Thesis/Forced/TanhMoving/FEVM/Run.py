...
def ForcedbedM(x,t,a0,a1,a2,a3,a4,a5,a6,a7,g,dx):
    ...
    for i in range(n):
        ...
        h[i] = a0 + a1*tanh(a2*(phi))
        u[i] = a4 + a5*tanh(a2*(phi))
        b[i] = a6*sin(a7*x[i])
        w[i] = h[i] + b[i]
        
        hxi = a1*a2*sech(a2*phi)**2
        uxi = a5*a2*sech(a2*phi)**2

        uxxi = -2*a2**2*a5*sech(a2*phi)**2*tanh(a2*phi)
...
#Forcing Problem    
wdir = "../../../../../../../data/raw/Forced/P1P2P3BedFEM/Tanh/expt12/"  
...
for j in range(11,12):
    ...
    print(t)
    hMbeg,uMbeg,GMbeg,bta,wMbeg = ForcedbedM(xhuMbeg,t,a0,a1,a2,a3,a4,a5,a6,a7,g,dx)
    hMend ,uMend ,GMend ,bta,wMend = ForcedbedM(xhuMend ,t,a0,a1,a2,a3,a4,a5,a6,a7,g,dx)
    bMbeg = a6*sin(a7*xbMbeg)
    bMend = a6*sin(a7*xbMend)
    ...
    while t < endt:  
        evolvewrapForcing(G_c,h_c,b_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c ,GMend_c,uMbeg_c,uMend_c,bMbeg_c,bMend_c,hMbeg_c,hMend_c,wMbeg_c,wMend_c,GMbeg_c,GMend_c,uMbeg_c,uMend_c,g,dx,dt,n,GhnBC,unBC,bnBC,nGhhbc,nubc,nbhbc,theta,hhbc_c, whbc_c,Ghbc_c,bhbc_c,ubc_c,x_c,t,a0,a1,a2,a3,a4,a5,a6,a7)
        t = t + dt
        ts.append(t)
        print(t)
