...
void evolve(double *hbc,double *Gbc, double *hblank,double *Gblank,double *bedbc, double *ubc ,double g,double theta, int n, int nBCn,double dx,double dt,double *x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7)
{
	...
	for(i = nBCn; i < n + nBCn; i++)
    {
        ...
        hS = ht(x[i- nBCn],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + Fluxhdiff(x[i- nBCn],t,a0,a1,a2,a3,a4,a5,a6,a7,g);

        GS = Gt(x[i- nBCn],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + FluxGdiff(x[i- nBCn],t,a0,a1,a2,a3,a4,a5,a6,a7,g) + SourceG(x[i- nBCn],t,a0,a1,a2,a3,a4,a5,a6,a7,g);
...
void evolvewrapBC(double *G,double *h,double *bed,double *h0,double *h1,double *u0,double *u1, double *G0, double *G1,double *h0h,double *h1h,double *u0h,double *u1h, double *G0h, double *G1h,double *b0,double *b1, double g,double dx,double dt, int n, int nBC, int nBCn,double theta, double *hbc, double *Gbc, double *ubc,double *x, double t,double a0,double a1,double a2, double a3, double a4, double a5, double a6, double a7)
{ 
...
//UNFINISHED~~~
	...
	evolve(ihbc,iGbc, hp,Gp,ibbc,iubc,g,theta,n,nBCn,dx,dt,x,t,a0,a1,a2,a3,a4,a5,a6,a7);


	evolveBC(hp,Gp,bed,u0h,u1h,h0h,h1h,G0h,G1h,b0,b1,n,nBC,nBCn,dx,ihbc, iGbc, iubc, ibbc);
	evolve(ihbc,iGbc, hpp,Gpp,ibbc,iubc,g,theta,n,nBCn,dx,dt,x,t + dt,a0,a1,a2,a3,a4,a5,a6,a7);
