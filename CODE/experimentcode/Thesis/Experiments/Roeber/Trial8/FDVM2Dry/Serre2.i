 ...
 extern void evolvewrapBC(double *h, double *G,double *bed, double *hMbeg, double *GMbeg, double  *wMbeg, double *bMbeg, double *duMbeg, double *uEbeg, double *ddbCbeg, double *hMend, double *GMend, double  *wMend, double *bMend, double *duMend, double *uEend, double *ddbCend, double *hMbeg1, double *GMbeg1, double  *wMbeg1, double *duMbeg1, double *uEbeg1, double *hMend1, double *GMend1, double  *wMend1, double *duMend1, double *uEend1, int nMBC, int nEBC, int nCBC, int n,int nMbc, int nEbc, int nCbc, double dx, double dt, double g, double theta);
