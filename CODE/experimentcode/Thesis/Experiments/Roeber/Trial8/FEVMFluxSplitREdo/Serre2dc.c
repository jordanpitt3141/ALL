...
//printf("%d  right : %e | %e | %e | %e | %e \n",i,her,Ger,dber,uer,duer );
//printf("%d  left : %e | %e | %e | %e | %e \n",i,hel,Gel,dbel,uel,duel );
...
void evolvewrapForcingANA(double *h, double *G, double *b,double *hMbeg, double *hMend,double *GMbeg, double *GMend,double *wMbeg, double *wMend,double *bMbeg, double *bMend, double *uMbeg, double *uMend,double *hMbegdt, double *hMenddt,double *GMbegdt, double *GMenddt,double *wMbegdt, double *wMenddt, double *uMbegdt, double *uMenddt,int n, int hnBC , int hnbc, int bnBC, int bnMBC , int bnbc, int unBC , int unbc,double theta,double dx, double dt, double g)
{
    double idx = 1.0 /dx;
    ...
    ReconWrap(hp,Gp,b,hMbegdt,hMenddt,GMbegdt,GMenddt,wMbegdt,wMenddt,bMbeg,bMend,uMbegdt,uMenddt,n,hnBC,hnbc,bnBC,bnMBC,bnbc,unBC,unbc,theta,dx,dt,g,wp,hpbc,Gpbc,wpbc,bbc,RegIndp,m1,RegIndLen);

    getufromGsplit(hpbc, Gpbc, bbc,uMbegdt,uMenddt,dx ,n,u_length ,hnBC,bnBC,hnbc,bnbc,unBC,unbc,RegIndp,m1,RegIndLen,upbc);
