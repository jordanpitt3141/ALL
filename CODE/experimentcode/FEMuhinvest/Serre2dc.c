...
void getufromG(double *h, double *G, double *hMbeg, double *hMend, double *GMbeg, double *GMend,double *uMbeg, double *uMend,double theta, double dx , int n, int m, int nGhBC,int unBC, int nGhbc, int nubc, double *u, double *hhbc,double *Ghbc)
{
    ...
    for (i =1;i < n-1 ; i++)
    {
        ...
        else
        {
            ...
            uhintia11 = 0.5*dx*((4.0/21)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjmhp+(1.0/210)*hjphm*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjphm+(1.0/210)*hjphm*(hjmhp + diffSTAB)/hjphm+(1.0/210)*hjmhp*(hjphm + diffSTAB)/hjphm+(1.0/210)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia12 = 0.5*dx*((2.0/21)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjmhp+(0)*hjphm*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjphm+(0)*hjphm*(hjmhp + diffSTAB)/hjphm+(0)*hjmhp*(hjphm + diffSTAB)/hjphm+(-2.0/105)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia13 = 0.5*dx*((-2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(-1.0/210)*hjphm*(hjmhp + diffSTAB)/hjmhp+(-1.0/210)*hjmhp*(hjphm + diffSTAB)/hjmhp+(-1.0/210)*hjphm*(hjphm + diffSTAB)/hjmhp+(-1.0/210)*hjmhp*(hjmhp + diffSTAB)/hjphm+(-1.0/210)*hjphm*(hjmhp + diffSTAB)/hjphm+(-1.0/210)*hjmhp*(hjphm + diffSTAB)/hjphm+(-2.0/105)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia21 = 0.5*dx*((2.0/21)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjmhp+(0)*hjphm*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjphm+(0)*hjphm*(hjmhp + diffSTAB)/hjphm+(0)*hjmhp*(hjphm + diffSTAB)/hjphm+(-2.0/105)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia22 = 0.5*dx*((4.0/21)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(4.0/35)*hjphm*(hjmhp + diffSTAB)/hjmhp+(4.0/35)*hjmhp*(hjphm + diffSTAB)/hjmhp+(4.0/35)*hjphm*(hjphm + diffSTAB)/hjmhp+(4.0/35)*hjmhp*(hjmhp + diffSTAB)/hjphm+(4.0/35)*hjphm*(hjmhp + diffSTAB)/hjphm+(4.0/35)*hjmhp*(hjphm + diffSTAB)/hjphm+(4.0/21)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia23 = 0.5*dx*((-2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(0)*hjphm*(hjmhp + diffSTAB)/hjmhp+(0)*hjmhp*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjphm + diffSTAB)/hjmhp+(0)*hjmhp*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjphm+(2.0/21)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia31 = 0.5*dx*((-2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(-1.0/210)*hjphm*(hjmhp + diffSTAB)/hjmhp+(-1.0/210)*hjmhp*(hjphm + diffSTAB)/hjmhp+(-1.0/210)*hjphm*(hjphm + diffSTAB)/hjmhp+(-1.0/210)*hjmhp*(hjmhp + diffSTAB)/hjphm+(-1.0/210)*hjphm*(hjmhp + diffSTAB)/hjphm+(-1.0/210)*hjmhp*(hjphm + diffSTAB)/hjphm+(-2.0/105)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia32 = 0.5*dx*((-2.0/105)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(0)*hjphm*(hjmhp + diffSTAB)/hjmhp+(0)*hjmhp*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjphm + diffSTAB)/hjmhp+(0)*hjmhp*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjphm+(2.0/21)*hjphm*(hjphm + diffSTAB)/hjphm);

            uhintia33 = 0.5*dx*((1.0/210)*hjmhp*(hjmhp + diffSTAB)/hjmhp+(1.0/210)*hjphm*(hjmhp + diffSTAB)/hjmhp+(1.0/210)*hjmhp*(hjphm + diffSTAB)/hjmhp+(2.0/105)*hjphm*(hjphm + diffSTAB)/hjmhp+(1.0/210)*hjmhp*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjphm*(hjmhp + diffSTAB)/hjphm+(2.0/105)*hjmhp*(hjphm + diffSTAB)/hjphm+(4.0/21)*hjphm*(hjphm + diffSTAB)/hjphm);
...
void evolve(double *Ghbc, double *hhbc, double *ubc, int nGhhbc, int nubc, int nGhBC, int unBC, double g, double dx, double dt, int n, double theta, double *newG, double *newh)
{
    ...
    for(i = 0;i < n;i++)
    {
		...
		newh[i] = fmax(hhbc[3*(i) +nGhBC + 1] - dt*idx*(foh - fih),0);
		newG[i] = (newh[i]> 0)*(Ghbc[3*(i) +nGhBC + 1] - dt*idx*(foG - fiG));
