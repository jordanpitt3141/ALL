...
def getufromG(h, G, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, theta, dx, n, m, nGhBC, unBC, nGhbc, nubc, u, hhbc, Ghbc, MollF, Molls):
    return _Serre2dc.getufromG(h, G, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, theta, dx, n, m, nGhBC, unBC, nGhbc, nubc, u, hhbc, Ghbc, MollF, Molls)
...
def evolvewrapperADAP(G, h, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, g, dx, dt, n, nGhBC, unBC, nGhhbc, nubc, theta, hhbc, Ghbc, ubc, Gp, hp, Gpp, hpp, MollF, Molls):
    return _Serre2dc.evolvewrapperADAP(G, h, hMbeg, hMend, GMbeg, GMend, uMbeg, uMend, g, dx, dt, n, nGhBC, unBC, nGhhbc, nubc, theta, hhbc, Ghbc, ubc, Gp, hp, Gpp, hpp, MollF, Molls)
...
def four1(data1, nn, isign):
    return _Serre2dc.four1(data1, nn, isign)
four1 = _Serre2dc.four1

def realft(data1, n, isign):
    return _Serre2dc.realft(data1, n, isign)
realft = _Serre2dc.realft

def convlv(data1, n, respns1, m, isign, ans1):
    return _Serre2dc.convlv(data1, n, respns1, m, isign, ans1)
convlv = _Serre2dc.convlv
