 ...
 extern void getufromG(double *h, double *G, double *hMbeg, double *hMend, double *GMbeg, double *GMend,double *uMbeg, double *uMend,double theta, double dx , int n, int m, int nGhBC,int unBC, int nGhbc, int nubc, double *u, double *hhbc,double *Ghbc, double *MollF, double Molls);
 ...
 extern void four1(double *data1, unsigned long nn, int isign);
 extern void realft(double *data1, unsigned long n, int isign);
 extern void convlv(double *data1, unsigned long n, double *respns1, unsigned long m,int isign, double *ans1);
