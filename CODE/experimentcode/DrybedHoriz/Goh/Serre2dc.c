...
void getufromG(double *h, double *G, double *hMbeg, double *hMend, double *GMbeg, double *GMend,double *uMbeg, double *uMend,double theta, double dx , int n, int m, int nGhBC,int unBC, int nGhbc, int nubc, double *u, double *hhbc,double *Ghbc)
{
    ...
    for (i =1;i < n-1 ; i++)
    {
        ...
        //uh integral
        uhinitia11 = 0.5*dx*((13.0/70)*hjmhp+(2.0/21)*hj+(-1.0/70)*hjphm);
        uhinitia12 = 0.5*dx*((2.0/21)*hjmhp+(8.0/105)*hj+(-4.0/105)*hjphm);
        uhinitia13 = 0.5*dx*((-1.0/70)*hjmhp+(-4.0/105)*hj+(-1.0/70)*hjphm);

        uhinitia21 = 0.5*dx*((2.0/21)*hjmhp+(8.0/105)*hj+(-4.0/105)*hjphm);
        uhinitia22 = 0.5*dx*((8.0/105)*hjmhp+(32.0/35)*hj+(8.0/105)*hjphm);
        uhinitia23 = 0.5*dx*((-4.0/105)*hjmhp+(8.0/105)*hj+(2.0/21)*hjphm);

        uhinitia31 = 0.5*dx*((-1.0/70)*hjmhp+(-4.0/105)*hj+(-1.0/70)*hjphm);
        uhinitia32 = 0.5*dx*((-4.0/105)*hjmhp+(8.0/105)*hj+(2.0/21)*hjphm);
        uhinitia33 = 0.5*dx*((-1.0/70)*hjmhp+(2.0/21)*hj+(13.0/70)*hjphm);
        
        //h3ux

        h3uxinitia11 = 2*idx*((46.0/105)*hjmhp*hjmhp+(47.0/210)*hj*hjmhp+(-19.0/420)*hjphm*hjmhp+(47.0/210)*hjmhp*hj+(44.0/105)*hj*hj+(-3.0/70)*hjphm*hj+(-19.0/420)*hjmhp*hjphm+(-3.0/70)*hj*hjphm+(4.0/105)*hjphm*hjphm);
        h3uxinitia12 = 2*idx*((-19.0/35)*hjmhp*hjmhp+(-26.0/105)*hj*hjmhp+(2.0/35)*hjphm*hjmhp+(-26.0/105)*hjmhp*hj+(-32.0/105)*hj*hj+(2.0/105)*hjphm*hj+(2.0/35)*hjmhp*hjphm+(2.0/105)*hj*hjphm+(-1.0/7)*hjphm*hjphm);
        h3uxinitia13 = 2*idx*((11.0/105)*hjmhp*hjmhp+(1.0/42)*hj*hjmhp+(-1.0/84)*hjphm*hjmhp+(1.0/42)*hjmhp*hj+(-4.0/35)*hj*hj+(1.0/42)*hjphm*hj+(-1.0/84)*hjmhp*hjphm+(1.0/42)*hj*hjphm+(11.0/105)*hjphm*hjphm);

        h3uxinitia21 = 2*idx*((-19.0/35)*hjmhp*hjmhp+(-26.0/105)*hj*hjmhp+(2.0/35)*hjphm*hjmhp+(-26.0/105)*hjmhp*hj+(-32.0/105)*hj*hj+(2.0/105)*hjphm*hj+(2.0/35)*hjmhp*hjphm+(2.0/105)*hj*hjphm+(-1.0/7)*hjphm*hjphm);
        h3uxinitia22 = 2*idx*((24.0/35)*hjmhp*hjmhp+(8.0/35)*hj*hjmhp+(-4.0/35)*hjphm*hjmhp+(8.0/35)*hjmhp*hj+(64.0/105)*hj*hj+(8.0/35)*hjphm*hj+(-4.0/35)*hjmhp*hjphm+(8.0/35)*hj*hjphm+(24.0/35)*hjphm*hjphm);
        h3uxinitia23 = 2*idx*((-1.0/7)*hjmhp*hjmhp+(2.0/105)*hj*hjmhp+(2.0/35)*hjphm*hjmhp+(2.0/105)*hjmhp*hj+(-32.0/105)*hj*hj+(-26.0/105)*hjphm*hj+(2.0/35)*hjmhp*hjphm+(-26.0/105)*hj*hjphm+(-19.0/35)*hjphm*hjphm);

        h3uxinitia31 = 2*idx*((11.0/105)*hjmhp*hjmhp+(1.0/42)*hj*hjmhp+(-1.0/84)*hjphm*hjmhp+(1.0/42)*hjmhp*hj+(-4.0/35)*hj*hj+(1.0/42)*hjphm*hj+(-1.0/84)*hjmhp*hjphm+(1.0/42)*hj*hjphm+(11.0/105)*hjphm*hjphm);
        h3uxinitia32 = 2*idx*((-1.0/7)*hjmhp*hjmhp+(2.0/105)*hj*hjmhp+(2.0/35)*hjphm*hjmhp+(2.0/105)*hjmhp*hj+(-32.0/105)*hj*hj+(-26.0/105)*hjphm*hj+(2.0/35)*hjmhp*hjphm+(-26.0/105)*hj*hjphm+(-19.0/35)*hjphm*hjphm);
        h3uxinitia33 = 2*idx*((4.0/105)*hjmhp*hjmhp+(-3.0/70)*hj*hjmhp+(-19.0/420)*hjphm*hjmhp+(-3.0/70)*hjmhp*hj+(44.0/105)*hj*hj+(47.0/210)*hjphm*hj+(-19.0/420)*hjmhp*hjphm+(47.0/210)*hj*hjphm+(46.0/105)*hjphm*hjphm);
        


        hhxuxinitia11 = 4*idx*idx*((-19.0/24)*hjmhp*hjmhp+(-17.0/30)*hj*hjmhp+(13.0/120)*hjphm*hjmhp+(29.0/30)*hjmhp*hj+(8.0/15)*hj*hj+(-1.0/6)*hjphm*hj+(-7.0/40)*hjmhp*hjphm+(1.0/30)*hj*hjphm+(7.0/120)*hjphm*hjphm);
        hhxuxinitia12 = 4*idx*idx*((29.0/30)*hjmhp*hjmhp+(8.0/15)*hj*hjmhp+(-1.0/6)*hjphm*hjmhp+(-6.0/5)*hjmhp*hj+(-8.0/15)*hj*hj+(2.0/5)*hjphm*hj+(7.0/30)*hjmhp*hjphm+(0)*hj*hjphm+(-7.0/30)*hjphm*hjphm);
        hhxuxinitia13 = 4*idx*idx*((-7.0/40)*hjmhp*hjmhp+(1.0/30)*hj*hjmhp+(7.0/120)*hjphm*hjmhp+(7.0/30)*hjmhp*hj+(0)*hj*hj+(-7.0/30)*hjphm*hj+(-7.0/120)*hjmhp*hjphm+(-1.0/30)*hj*hjphm+(7.0/40)*hjphm*hjphm);

        hhxuxinitia21 = 4*idx*idx*((29.0/30)*hjmhp*hjmhp+(8.0/15)*hj*hjmhp+(-1.0/6)*hjphm*hjmhp+(-6.0/5)*hjmhp*hj+(-8.0/15)*hj*hj+(2.0/5)*hjphm*hj+(7.0/30)*hjmhp*hjphm+(0)*hj*hjphm+(-7.0/30)*hjphm*hjphm);
        hhxuxinitia22 = 4*idx*idx*((-6.0/5)*hjmhp*hjmhp+(-8.0/15)*hj*hjmhp+(2.0/5)*hjphm*hjmhp+(8.0/5)*hjmhp*hj+(0)*hj*hj+(-8.0/5)*hjphm*hj+(-2.0/5)*hjmhp*hjphm+(8.0/15)*hj*hjphm+(6.0/5)*hjphm*hjphm);
        hhxuxinitia23 = 4*idx*idx*((7.0/30)*hjmhp*hjmhp+(0)*hj*hjmhp+(-7.0/30)*hjphm*hjmhp+(-2.0/5)*hjmhp*hj+(8.0/15)*hj*hj+(6.0/5)*hjphm*hj+(1.0/6)*hjmhp*hjphm+(-8.0/15)*hj*hjphm+(-29.0/30)*hjphm*hjphm);

        hhxuxinitia31 = 4*idx*idx*((-7.0/40)*hjmhp*hjmhp+(1.0/30)*hj*hjmhp+(7.0/120)*hjphm*hjmhp+(7.0/30)*hjmhp*hj+(0)*hj*hj+(-7.0/30)*hjphm*hj+(-7.0/120)*hjmhp*hjphm+(-1.0/30)*hj*hjphm+(7.0/40)*hjphm*hjphm);
        hhxuxinitia32 = 4*idx*idx*((7.0/30)*hjmhp*hjmhp+(0)*hj*hjmhp+(-7.0/30)*hjphm*hjmhp+(-2.0/5)*hjmhp*hj+(8.0/15)*hj*hj+(6.0/5)*hjphm*hj+(1.0/6)*hjmhp*hjphm+(-8.0/15)*hj*hjphm+(-29.0/30)*hjphm*hjphm);
        hhxuxinitia33 = 4*idx*idx*((-7.0/120)*hjmhp*hjmhp+(-1.0/30)*hj*hjmhp+(7.0/40)*hjphm*hjmhp+(1.0/6)*hjmhp*hj+(-8.0/15)*hj*hj+(-29.0/30)*hjphm*hj+(-13.0/120)*hjmhp*hjphm+(17.0/30)*hj*hjphm+(19.0/24)*hjphm*hjphm);        
