...
void getufromG(double *hbc, double *Gbc, double *bbc, double *uMbeg, double *uMend, double dx , int n, int m, double *ubc)
{
   ...
   // G integral (RHS)
    ...
    uhintia11 = (Suhinit/Duhinit)*(1.0 *i60)*dx*(7*hjmhp + hjphm);
    uhintia12 = 0;
    uhintia13 = 0;
    
    uhintia21 = 0;
    uhintia22 = (Suhinit/Duhinit)*(1.0 *i60)*dx*(16*hjmhp + 16*hjphm);
    uhintia23 = 0;
    
    uhintia31 = 0;
    uhintia32 = 0;
    uhintia33 = (Suhinit/Duhinit)*(1.0 *i60)*dx*(hjmhp + 7*hjphm);
