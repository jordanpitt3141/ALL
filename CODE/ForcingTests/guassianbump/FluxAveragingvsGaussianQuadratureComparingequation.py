...
for j in range(12):   
    ...
    for i in range(n): 
        ...
        hAjn = hA(xi1,xi2,ti1,a0,a1,a2,a3,a4,a5,a6,a7)
        hAjnp1 = hA(xi1,xi2,ti2,a0,a1,a2,a3,a4,a5,a6,a7)
        ...
        FhxXTv = FhxXT(ti1,ti2,xi1,xi2,a0,a1,a2,a3,a4,a5,a6,a7,g)
        
        LHS = dx*(hAjnp1 - hAjn) + dt*(FhAjphn- FhAjmhn)
        RHS = htXTv +FhxXTv 
        
        htv = ht(x1[i],ti1,a0,a1,a2,a3,a4,a5,a6,a7,g) 
        Fhxv = Fhx(x1[i],ti1,a0,a1,a2,a3,a4,a5,a6,a7,g)   
        
        THS = dt*dx*(htv + Fhxv)
        
        #print(dx*(hAjnp1 - hAjn), htXTv , dx*(hAjnp1 - hAjn)- htXTv)
        
        #GAjn = GA(xi1,xi2,ti1,a0,a1,a2,a3,a4,a5,a6,a7)
        #GAjnp1 = GA(xi1,xi2,ti2,a0,a1,a2,a3,a4,a5,a6,a7)
    
        #FhAjphn = FhA(xi2,ti1,ti2,a0,a1,a2,a3,a4,a5,a6,a7,g)
        #FhAjmhn = FhA(xi1,ti1,ti2,a0,a1,a2,a3,a4,a5,a6,a7,g)    
        
        #FGAjphn = FGA(xi2,ti1,ti2,a0,a1,a2,a3,a4,a5,a6,a7)
        #FGAjmhn = FGA(xi1,ti1,ti2,a0,a1,a2,a3,a4,a5,a6,a7)
    ...
    Err1 = norm(LHSs - RHSs)/ norm(RHSs)   
    Err2 = norm(THSs - RHSs)/ norm(RHSs)
    norms1.append(Err1)
    norms2.append(Err2)
