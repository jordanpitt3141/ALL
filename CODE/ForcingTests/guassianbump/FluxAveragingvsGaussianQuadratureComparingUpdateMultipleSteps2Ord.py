...
def Fluxh(x,t,a0,a1,a2,a3,a4,a5,a6,a7,g):
...
def htX(xi1,xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g):
    htXv = nquad(ht, [[xi1,xi2]],args=(t,a0,a1,a2,a3,a4,a5,a6,a7,g))
    return htXv[0]
...
def Fhx1(t,x,a0,a1,a2,a3,a4,a5,a6,a7,g):
    return -((a1*a5*(-a3 - a2*t + x))/(a4*pow(e,pow(-a3 - a2*t + x,2)/a4))) - (a5*(a0 + a1/pow(e,pow(-a3 - a2*t + x,2)/(2.*a4)))*(-a3 - a2*t + x))/(a4*pow(e,pow(-a3 - a2*t + x,2)/(2.*a4)))

  
def FhxT(ti1,ti2,x,a0,a1,a2,a3,a4,a5,a6,a7,g):
    htXTv = nquad(Fhx1, [[ti1,ti2]],args=(x,a0,a1,a2,a3,a4,a5,a6,a7,g))
    return htXTv[0]
...
def Evolve(x1,hAs,t,dx,dt): 
    ...
    for i in range(n): 
        ...
        #hAn  = hA(xi1,xi2,ti1,a0,a1,a2,a3,a4,a5,a6,a7)
        hAnp1  = hA(xi1,xi2,ti2,a0,a1,a2,a3,a4,a5,a6,a7)
        
        htXv =  htX(xi1,xi2,ti1,a0,a1,a2,a3,a4,a5,a6,a7,g)
        #htXTv = htXT(ti1,ti2,xi1,xi2,a0,a1,a2,a3,a4,a5,a6,a7,g)

        Fjph =  Fluxh(xi2,t,a0,a1,a2,a3,a4,a5,a6,a7,g)
        Fjmh =  Fluxh(xi1,t,a0,a1,a2,a3,a4,a5,a6,a7,g)
        
        hp[i] = hAs[i] + dt*htXv/dx  + dt/dx*((Fjph - FhAjphn)- (Fjmh - FhAjmhn))
        #hp[i] = hAs[i]+ dt*htXv/dx 
    return hp

wdir = "../tests/Evolve2FluxTime1T1ABCDEFG13TogethR/"  
