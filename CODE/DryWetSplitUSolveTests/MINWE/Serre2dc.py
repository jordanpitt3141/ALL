...
def deallocMem(array):
    return _Serre2dc.deallocMem(array)
deallocMem = _Serre2dc.deallocMem

def append(A, n, m, B):
    return _Serre2dc.append(A, n, m, B)
append = _Serre2dc.append

def RegSplit(n):
    return _Serre2dc.RegSplit(n)
